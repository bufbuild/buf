...
updatedockerignores:
	@rm -f .dockerignore
	@echo '# Autogenerated by make updatedockerignores. DO NOT EDIT.' > .dockerignore
	@$(foreach file_ignore,$(FILE_IGNORES),echo $(file_ignore) >> .dockerignore || exit 1;)
	@sort -o .dockerignore .dockerignore
