...
GO_GET_PKGS := $(GO_GET_PKGS) github.com/jhump/protoreflect@706a6d0046fe771f799a651a346c85eb946f696f
...
.PHONY: bufrelease
bufrelease:
	DOCKER_IMAGE=golang:1.14.2-buster bash make/buf/scripts/release.bash
