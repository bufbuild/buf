...
./compare.sh  beta registry repository delete buf.build/achiu/bufcli
...
./compare.sh  beta registry track delete buf.build/achiu/petapis
...
./compare.sh  beta registry template delete buf.build/achiu/templates/testtemplate
