...
- Fix LSP incorrectly reporting "edition '2024' not yet fully supported" errors for proto files using Edition 2024 by migrating the LSP image builder to the new compiler, which already supports Edition 2024.
