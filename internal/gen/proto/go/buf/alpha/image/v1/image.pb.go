...
type ImageExtension struct {
	...
	// ModuleRefs are the module references for this specific Image.
	//
	// The lack of a ModuleRef for a given file means that the module
	// reference information is not known, and must be treated as unknown.
	ModuleRefs []*ModuleRef `protobuf:"bytes,4,rep,name=module_refs,json=moduleRefs" json:"module_refs,omitempty"`
}
...
func (x *ImageExtension) GetModuleRefs() []*ModuleRef {
	if x != nil {
		return x.ModuleRefs
	}
	return nil
...
func (x *ModuleRef) GetFileIndex() uint32 {
	if x != nil && x.FileIndex != nil {
		return *x.FileIndex
	}
	return 0
...
func (x *ModuleRef) GetRemote() string {
...
func (x *ModuleRef) GetCommit() string {
...
var file_buf_alpha_image_v1_image_proto_rawDesc = []byte{
	...
	0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xd7, 0x01, 0x0a, 0x0e, 0x49, 0x6d,
	...
	,
	...
	0x6e, 0x64, 0x65, 0x78, 0x22, 0x90, 0x01, 0x0a, 0x09, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x52,
	0x65, 0x66, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x64, 0x65,
	0x78, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x16, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x42, 0x73, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x62,
	0x75, 0x66, 0x2e, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x2e, 0x76,
	0x31, 0x42, 0x0a, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x48, 0x01, 0x5a,
	...
	0x31, 0x3b, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x76, 0x31, 0xf8, 0x01, 0x01,
}
...
var file_buf_alpha_image_v1_image_proto_goTypes = []interface{}{
	...
	(*ModuleRef)(nil),                        // 3: buf.alpha.image.v1.ModuleRef
...
var file_buf_alpha_image_v1_image_proto_depIdxs = []int32{
	...
	3, // 3: buf.alpha.image.v1.ImageExtension.module_refs:type_name -> buf.alpha.image.v1.ModuleRef
