...
// Package protosrc defines minimal interfaces for Protobuf descriptor types.
//
...
func DirPathToFiles(files ...File) (map[string][]File, error) {
	return mapFiles(files, func(file File) string { return normalpath.Dir(file.FilePath()) })
}
