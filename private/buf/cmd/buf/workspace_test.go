...
func TestWorkspaceWithInvalidWorkspaceDirectoryPathFail(t *testing.T) {
	...
	testRunStdoutStderr(
		...
		1,
		``,
		filepath.FromSlash(`Failure: path "testdata/workspace/success/dir/notexist" has no matching file in the module`),
		"lint",
		filepath.Join("testdata", "workspace", "success", "dir"),
		"--path",
...
func TestWorkspaceWithInvalidDirPathFail(t *testing.T) {
	...
	testRunStdoutStderr(
		...
		1,
		``,
		filepath.FromSlash(`Failure: path "testdata/workspace/success/detached/proto/notexist" has no matching file in the module`),
		"lint",
		filepath.Join("testdata", "workspace", "success", "detached", "proto"),
		"--path",
