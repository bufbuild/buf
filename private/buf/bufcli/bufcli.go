...
// parseFullyQualifiedPath parse a string in <buf.build/owner/name#fully-qualified-type> or
// <buf.build/owner/name:reference#fully-qualified-type> format into a module reference and a type name
