...
func Serve(
	...
	lspState.bufYAMLManager = newBufYAMLManager(lspState)
	lspState.bufGenYAMLManager = newBufGenYAMLManager()
	lspState.bufPolicyYAMLManager = newBufPolicyYAMLManager()
	lspState.bufLockManager = newBufLockManager()
