...
type RemotePluginService interface {
	...
	ListRemotePlugins(
		...
		pageToken string,
		reverse bool,
	) (plugins []*v1alpha1.RemotePlugin, nextPageToken string, err error)
	...
	) (pluginReference *v1alpha1.RemotePluginReference, err error)
}
