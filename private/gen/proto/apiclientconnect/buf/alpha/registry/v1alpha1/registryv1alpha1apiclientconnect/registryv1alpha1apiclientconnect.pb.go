...
func (p *provider) NewWebhookEventService(ctx context.Context, address string) (registryv1alpha1api.WebhookEventService, error) {
	var contextModifier func(context.Context) context.Context
	var err error
	if p.contextModifierProvider != nil {
		contextModifier, err = p.contextModifierProvider(address)
	...
	return &webhookEventServiceClient{
		logger: p.logger,
		client: registryv1alpha1connect.NewWebhookEventServiceClient(
			p.httpClient,
			address,
		),
		contextModifier: contextModifier,
