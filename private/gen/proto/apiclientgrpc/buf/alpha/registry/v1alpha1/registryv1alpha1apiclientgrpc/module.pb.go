...
type moduleService struct {
	logger          *zap.Logger
	client          v1alpha1.ModuleServiceClient
...
func (s *moduleService) GetModule(
	ctx context.Context,
	id string,
) (module *v1alpha1.Module, counts *v1alpha1.ModuleCounts, _ error) {
	if s.contextModifier != nil {
		ctx = s.contextModifier(ctx)
	}
	response, err := s.client.GetModule(
		ctx,
		&v1alpha1.GetModuleRequest{
			Id: id,
		},
	)
	if err != nil {
...
func (s *moduleService) GetModuleByFullName(
	...
	response, err := s.client.GetModuleByFullName(
		ctx,
		&v1alpha1.GetModuleByFullNameRequest{
			FullName: fullName,
		},
	)
	if err != nil {
...
func (s *moduleService) ListModules(
	...
	pageToken string,
	reverse bool,
) (modules []*v1alpha1.Module, nextPageToken string, _ error) {
	if s.contextModifier != nil {
		ctx = s.contextModifier(ctx)
	}
	response, err := s.client.ListModules(
		ctx,
		&v1alpha1.ListModulesRequest{
			PageSize:  pageSize,
			PageToken: pageToken,
			Reverse:   reverse,
		},
...
func (s *moduleService) ListUserModules(
	...
	response, err := s.client.ListUserModules(
		ctx,
		&v1alpha1.ListUserModulesRequest{
			UserId:    userId,
			PageSize:  pageSize,
			PageToken: pageToken,
			Reverse:   reverse,
...
func (s *moduleService) ListModulesUserCanAccess(
	...
	response, err := s.client.ListModulesUserCanAccess(
		ctx,
		&v1alpha1.ListModulesUserCanAccessRequest{
			PageSize:  pageSize,
			PageToken: pageToken,
			Reverse:   reverse,
		},
...
func (s *moduleService) ListOrganizationModules(
	...
	response, err := s.client.ListOrganizationModules(
		ctx,
		&v1alpha1.ListOrganizationModulesRequest{
...
func (s *moduleService) CreateModuleByFullName(
	...
	response, err := s.client.CreateModuleByFullName(
		ctx,
		&v1alpha1.CreateModuleByFullNameRequest{
			FullName:   fullName,
...
func (s *moduleService) DeleteModuleByFullName(ctx context.Context, fullName string) (_ error) {
	...
	_, err := s.client.DeleteModuleByFullName(
		ctx,
		&v1alpha1.DeleteModuleByFullNameRequest{
			FullName: fullName,
		},
	)
	if err != nil {
...
func (s *moduleService) DeprecateModuleByName(
	...
	response, err := s.client.DeprecateModuleByName(
		ctx,
		&v1alpha1.DeprecateModuleByNameRequest{
			OwnerName:          ownerName,
...
func (s *moduleService) UndeprecateModuleByName(
	...
	response, err := s.client.UndeprecateModuleByName(
		ctx,
		&v1alpha1.UndeprecateModuleByNameRequest{
			OwnerName:  ownerName,
			ModuleName: moduleName,
		},
	)
...
func (s *moduleService) GetModulesByFullName(ctx context.Context, fullNames []string) (modules []*v1alpha1.Module, _ error) {
	if s.contextModifier != nil {
		ctx = s.contextModifier(ctx)
	}
	response, err := s.client.GetModulesByFullName(
		ctx,
		&v1alpha1.GetModulesByFullNameRequest{
			FullNames: fullNames,
		},
	)
	if err != nil {
...
func (s *moduleService) SetModuleContributor(
	...
	_, err := s.client.SetModuleContributor(
		ctx,
		&v1alpha1.SetModuleContributorRequest{
			ModuleId:   moduleId,
			UserId:     userId,
...
func (s *moduleService) ListModuleContributors(
	...
	pageToken string,
	reverse bool,
) (users []*v1alpha1.ModuleContributor, nextPageToken string, _ error) {
	if s.contextModifier != nil {
		ctx = s.contextModifier(ctx)
	}
	response, err := s.client.ListModuleContributors(
		ctx,
		&v1alpha1.ListModuleContributorsRequest{
			ModuleId:  moduleId,
			PageSize:  pageSize,
			PageToken: pageToken,
			Reverse:   reverse,
...
func (s *moduleService) GetModuleContributor(
	...
	moduleId string,
	userId string,
) (user *v1alpha1.ModuleContributor, _ error) {
	if s.contextModifier != nil {
		ctx = s.contextModifier(ctx)
	}
	response, err := s.client.GetModuleContributor(
		ctx,
		&v1alpha1.GetModuleContributorRequest{
			ModuleId: moduleId,
			UserId:   userId,
		},
	)
...
func (s *moduleService) GetModuleSettings(ctx context.Context, moduleId string) (contributorsCount uint32, _ error) {
	...
	response, err := s.client.GetModuleSettings(
		ctx,
		&v1alpha1.GetModuleSettingsRequest{
			ModuleId: moduleId,
		},
	)
	if err != nil {
...
func (s *moduleService) UpdateModuleSettingsByName(
	...
	_, err := s.client.UpdateModuleSettingsByName(
		ctx,
		&v1alpha1.UpdateModuleSettingsByNameRequest{
			OwnerName:  ownerName,
			ModuleName: moduleName,
			Visibility: visibility,
		},
