...
// Because the request agent needs to be able to receive simple CORS requests,
// we're limited to the text/plain Content-Type. This isn't suported out of the
// box in gRPC-Web, so for now we avoid using it and do plain POST with base64
// proto request/response messages.
//
// We may explore websocket transports later, at which point we should define
// services methods here.
...
type InvokeRequest struct {
	...
	Headers []*Metadata `protobuf:"bytes,2,rep,name=headers,proto3" json:"headers,omitempty"`
...
func (x *InvokeRequest) GetHeaders() []*Metadata {
	if x != nil {
		return x.Headers
	}
	return nil
...
type InvokeResponse struct {
	...
	Headers  []*Metadata `protobuf:"bytes,1,rep,name=headers,proto3" json:"headers,omitempty"`
	Body     []byte      `protobuf:"bytes,2,opt,name=body,proto3" json:"body,omitempty"`
	Trailers []*Metadata `protobuf:"bytes,3,rep,name=trailers,proto3" json:"trailers,omitempty"`
}
...
func (x *InvokeResponse) GetHeaders() []*Metadata {
	if x != nil {
		return x.Headers
	}
	return nil
...
func (x *InvokeResponse) GetTrailers() []*Metadata {
	if x != nil {
		return x.Trailers
	}
	return nil
...
var file_buf_alpha_studio_v1alpha1_invoke_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x31, 0x22, 0x32, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12,
	0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65,
	0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x7a, 0x0a, 0x0d, 0x49, 0x6e, 0x76, 0x6f, 0x6b,
	...
	0x0b, 0x32, 0x23, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x73, 0x74,
	0x75, 0x64, 0x69, 0x6f, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x12,
	0x12, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x62,
	0x6f, 0x64, 0x79, 0x22, 0xa4, 0x01, 0x0a, 0x0e, 0x49, 0x6e, 0x76, 0x6f, 0x6b, 0x65, 0x52, 0x65,
	...
	,
	...
	,
...
var file_buf_alpha_studio_v1alpha1_invoke_proto_goTypes = []interface{}{
	(*Metadata)(nil),       // 0: buf.alpha.studio.v1alpha1.Metadata
...
var file_buf_alpha_studio_v1alpha1_invoke_proto_depIdxs = []int32{
	0, // 0: buf.alpha.studio.v1alpha1.InvokeRequest.headers:type_name -> buf.alpha.studio.v1alpha1.Metadata
	0, // 1: buf.alpha.studio.v1alpha1.InvokeResponse.headers:type_name -> buf.alpha.studio.v1alpha1.Metadata
	0, // 2: buf.alpha.studio.v1alpha1.InvokeResponse.trailers:type_name -> buf.alpha.studio.v1alpha1.Metadata
