...
func (x *Image) MarshalWithDescriptorInfo() ([]byte, error) {
	...
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.image.v1.Image",
			},
		},
	)
	if err != nil {
...
func (x *ImageFile) MarshalWithDescriptorInfo() ([]byte, error) {
	bytes, err := proto.Marshal(x)
	if err != nil {
		return nil, err
	}
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.image.v1.ImageFile",
			},
		},
	)
	if err != nil {
...
func (x *ImageFileExtension) MarshalWithDescriptorInfo() ([]byte, error) {
	bytes, err := proto.Marshal(x)
	if err != nil {
		return nil, err
	}
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.image.v1.ImageFileExtension",
			},
		},
	)
	if err != nil {
	...
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.image.v1.ModuleInfo",
			},
		},
	)
	if err != nil {
	...
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.image.v1.ModuleName",
			},
		},
	)
	if err != nil {
