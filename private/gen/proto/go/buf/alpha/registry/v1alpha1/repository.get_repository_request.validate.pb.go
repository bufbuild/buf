...
//
//  has(this.id) ? 'true' : 'GetRepositoryRequest must have a non-empty id'
func (x *GetRepositoryRequest) Validate() error {
	return validateGetRepositoryRequest(x)
}

var validateGetRepositoryRequest func(*GetRepositoryRequest) error

func init() {
	defaultMessage := &GetRepositoryRequest{}
	...
	validateGetRepositoryRequest = func(x *GetRepositoryRequest) error {
		...
		return errors.New("GetRepositoryRequest is invalid; see the message definition for details")
	}
}
