...
type PluginCollection int32

const (
	PluginCollection_PLUGIN_COLLECTION_UNSPECIFIED PluginCollection = 0
	// PLUGIN_COLLECTION_PROTOBUF is the collection for Protobuf plugins. These are the base types
	// other plugins are built on.
	PluginCollection_PLUGIN_COLLECTION_PROTOBUF PluginCollection = 1
	// PLUGIN_COLLECTION_CONNECT is the collection for Connect plugins.
	PluginCollection_PLUGIN_COLLECTION_CONNECT PluginCollection = 2
	// PLUGIN_COLLECTION_GRPC is the collection for gRPC plugins.
	PluginCollection_PLUGIN_COLLECTION_GRPC PluginCollection = 3
	// PLUGIN_COLLECTION_OPENAPI is the collection for OpenAPI plugins.
	PluginCollection_PLUGIN_COLLECTION_OPENAPI PluginCollection = 4
)

// Enum value maps for PluginCollection.
var (
	PluginCollection_name = map[int32]string{
		0: "PLUGIN_COLLECTION_UNSPECIFIED",
		1: "PLUGIN_COLLECTION_PROTOBUF",
		2: "PLUGIN_COLLECTION_CONNECT",
		3: "PLUGIN_COLLECTION_GRPC",
		4: "PLUGIN_COLLECTION_OPENAPI",
	}
	PluginCollection_value = map[string]int32{
		"PLUGIN_COLLECTION_UNSPECIFIED": 0,
		"PLUGIN_COLLECTION_PROTOBUF":    1,
		"PLUGIN_COLLECTION_CONNECT":     2,
		"PLUGIN_COLLECTION_GRPC":        3,
		"PLUGIN_COLLECTION_OPENAPI":     4,
	}
)

func (x PluginCollection) Enum() *PluginCollection {
	p := new(PluginCollection)
	*p = x
	return p
}
...
func (PluginCollection) Descriptor() protoreflect.EnumDescriptor {
	return file_buf_alpha_registry_v1alpha1_plugin_curation_proto_enumTypes[7].Descriptor()
}

func (PluginCollection) Type() protoreflect.EnumType {
	return &file_buf_alpha_registry_v1alpha1_plugin_curation_proto_enumTypes[7]
}

func (x PluginCollection) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PluginCollection.Descriptor instead.
func (PluginCollection) EnumDescriptor() ([]byte, []int) {
...
type CuratedPlugin struct {
	...
	Collections []PluginCollection `protobuf:"varint,23,rep,packed,name=collections,proto3,enum=buf.alpha.registry.v1alpha1.PluginCollection" json:"collections,omitempty"`
}
...
var file_buf_alpha_registry_v1alpha1_plugin_curation_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x18, 0x17, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x2d, 0x2e, 0x62, 0x75, 0x66, 0x2e,
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x76,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xfa, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61,
	...
	0x41, 0x54, 0x45, 0x10, 0x02, 0x2a, 0xda, 0x02, 0x0a, 0x12, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	...
	0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x50, 0x59, 0x54, 0x48, 0x4f, 0x4e, 0x10, 0x05, 0x12, 0x1e,
	0x0a, 0x1a, 0x50, 0x4c, 0x55, 0x47, 0x49, 0x4e, 0x5f, 0x52, 0x45, 0x47, 0x49, 0x53, 0x54, 0x52,
	0x59, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x43, 0x41, 0x52, 0x47, 0x4f, 0x10, 0x07, 0x12, 0x1e,
	0x0a, 0x1a, 0x50, 0x4c, 0x55, 0x47, 0x49, 0x4e, 0x5f, 0x52, 0x45, 0x47, 0x49, 0x53, 0x54, 0x52,
	0x59, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4e, 0x55, 0x47, 0x45, 0x54, 0x10, 0x08, 0x12, 0x1e,
	0x0a, 0x1a, 0x50, 0x4c, 0x55, 0x47, 0x49, 0x4e, 0x5f, 0x52, 0x45, 0x47, 0x49, 0x53, 0x54, 0x52,
	0x59, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x43, 0x4d, 0x41, 0x4b, 0x45, 0x10, 0x09, 0x22, 0x04,
	...
	0x50, 0x45, 0x5f, 0x53, 0x54, 0x55, 0x42, 0x5f, 0x4f, 0x4e, 0x4c, 0x59, 0x10, 0x02, 0x2a, 0xe9,
	0x04, 0x0a, 0x15, 0x44, 0x6f, 0x74, 0x6e, 0x65, 0x74, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x46,
	0x72, 0x61, 0x6d, 0x65, 0x77, 0x6f, 0x72, 0x6b, 0x12, 0x27, 0x0a, 0x23, 0x44, 0x4f, 0x54, 0x4e,
	...
	0x00, 0x12, 0x2b, 0x0a, 0x27, 0x44, 0x4f, 0x54, 0x4e, 0x45, 0x54, 0x5f, 0x54, 0x41, 0x52, 0x47,
	0x45, 0x54, 0x5f, 0x46, 0x52, 0x41, 0x4d, 0x45, 0x57, 0x4f, 0x52, 0x4b, 0x5f, 0x4e, 0x45, 0x54,
	0x53, 0x54, 0x41, 0x4e, 0x44, 0x41, 0x52, 0x44, 0x5f, 0x31, 0x5f, 0x30, 0x10, 0x01, 0x12, 0x2b,
	...
	0x4e, 0x44, 0x41, 0x52, 0x44, 0x5f, 0x31, 0x5f, 0x31, 0x10, 0x02, 0x12, 0x2b, 0x0a, 0x27, 0x44,
	...
	,
	...
	0x41, 0x4e, 0x44, 0x41, 0x52, 0x44, 0x5f, 0x31, 0x5f, 0x36, 0x10, 0x07, 0x12, 0x2b, 0x0a, 0x27,
	...
	0x41, 0x52, 0x44, 0x5f, 0x32, 0x5f, 0x30, 0x10, 0x08, 0x12, 0x2b, 0x0a, 0x27, 0x44, 0x4f, 0x54,
	...
	0x5f, 0x32, 0x5f, 0x31, 0x10, 0x09, 0x12, 0x23, 0x0a, 0x1f, 0x44, 0x4f, 0x54, 0x4e, 0x45, 0x54,
	0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x5f, 0x46, 0x52, 0x41, 0x4d, 0x45, 0x57, 0x4f, 0x52,
	0x4b, 0x5f, 0x4e, 0x45, 0x54, 0x5f, 0x35, 0x5f, 0x30, 0x10, 0x0a, 0x12, 0x23, 0x0a, 0x1f, 0x44,
	0x4f, 0x54, 0x4e, 0x45, 0x54, 0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x5f, 0x46, 0x52, 0x41,
	0x4d, 0x45, 0x57, 0x4f, 0x52, 0x4b, 0x5f, 0x4e, 0x45, 0x54, 0x5f, 0x36, 0x5f, 0x30, 0x10, 0x0b,
	...
	,
...
var file_buf_alpha_registry_v1alpha1_plugin_curation_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_buf_alpha_registry_v1alpha1_plugin_curation_proto_goTypes = []any{
	...
	(PluginCollection)(0),                       // 7: buf.alpha.registry.v1alpha1.PluginCollection
	(*GoConfig)(nil),                            // 8: buf.alpha.registry.v1alpha1.GoConfig
	(*NPMConfig)(nil),                           // 9: buf.alpha.registry.v1alpha1.NPMConfig
	(*MavenConfig)(nil),                         // 10: buf.alpha.registry.v1alpha1.MavenConfig
	(*NugetConfig)(nil),                         // 11: buf.alpha.registry.v1alpha1.NugetConfig
	(*CmakeConfig)(nil),                         // 12: buf.alpha.registry.v1alpha1.CmakeConfig
	(*SwiftConfig)(nil),                         // 13: buf.alpha.registry.v1alpha1.SwiftConfig
	(*PythonConfig)(nil),                        // 14: buf.alpha.registry.v1alpha1.PythonConfig
	(*CargoConfig)(nil),                         // 15: buf.alpha.registry.v1alpha1.CargoConfig
	(*RegistryConfig)(nil),                      // 16: buf.alpha.registry.v1alpha1.RegistryConfig
	(*CuratedPluginReference)(nil),              // 17: buf.alpha.registry.v1alpha1.CuratedPluginReference
	(*CuratedPlugin)(nil),                       // 18: buf.alpha.registry.v1alpha1.CuratedPlugin
...
var file_buf_alpha_registry_v1alpha1_plugin_curation_proto_depIdxs = []int32{
	...
	8,  // 12: buf.alpha.registry.v1alpha1.RegistryConfig.go_config:type_name -> buf.alpha.registry.v1alpha1.GoConfig
	9,  // 13: buf.alpha.registry.v1alpha1.RegistryConfig.npm_config:type_name -> buf.alpha.registry.v1alpha1.NPMConfig
	10, // 14: buf.alpha.registry.v1alpha1.RegistryConfig.maven_config:type_name -> buf.alpha.registry.v1alpha1.MavenConfig
	13, // 15: buf.alpha.registry.v1alpha1.RegistryConfig.swift_config:type_name -> buf.alpha.registry.v1alpha1.SwiftConfig
	14, // 16: buf.alpha.registry.v1alpha1.RegistryConfig.python_config:type_name -> buf.alpha.registry.v1alpha1.PythonConfig
	15, // 17: buf.alpha.registry.v1alpha1.RegistryConfig.cargo_config:type_name -> buf.alpha.registry.v1alpha1.CargoConfig
	11, // 18: buf.alpha.registry.v1alpha1.RegistryConfig.nuget_config:type_name -> buf.alpha.registry.v1alpha1.NugetConfig
	12, // 19: buf.alpha.registry.v1alpha1.RegistryConfig.cmake_config:type_name -> buf.alpha.registry.v1alpha1.CmakeConfig
	...
	17, // 22: buf.alpha.registry.v1alpha1.CuratedPlugin.dependencies:type_name -> buf.alpha.registry.v1alpha1.CuratedPluginReference
	16, // 23: buf.alpha.registry.v1alpha1.CuratedPlugin.registry_config:type_name -> buf.alpha.registry.v1alpha1.RegistryConfig
	...
	7,  // 26: buf.alpha.registry.v1alpha1.CuratedPlugin.collections:type_name -> buf.alpha.registry.v1alpha1.PluginCollection
	...
	17, // 30: buf.alpha.registry.v1alpha1.PluginGenerationRequest.plugin_reference:type_name -> buf.alpha.registry.v1alpha1.CuratedPluginReference
	...
	17, // 33: buf.alpha.registry.v1alpha1.CreateCuratedPluginRequest.dependencies:type_name -> buf.alpha.registry.v1alpha1.CuratedPluginReference
	16, // 34: buf.alpha.registry.v1alpha1.CreateCuratedPluginRequest.registry_config:type_name -> buf.alpha.registry.v1alpha1.RegistryConfig
	...
	18, // 37: buf.alpha.registry.v1alpha1.CreateCuratedPluginResponse.configuration:type_name -> buf.alpha.registry.v1alpha1.CuratedPlugin
	18, // 38: buf.alpha.registry.v1alpha1.ListCuratedPluginsResponse.plugins:type_name -> buf.alpha.registry.v1alpha1.CuratedPlugin
	18, // 39: buf.alpha.registry.v1alpha1.GetLatestCuratedPluginResponse.plugin:type_name -> buf.alpha.registry.v1alpha1.CuratedPlugin
