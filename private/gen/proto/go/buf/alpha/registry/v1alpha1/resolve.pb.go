...
type ResolveReferenceRequest struct {
	...
	Plugin *PluginRef `protobuf:"bytes,1,opt,name=plugin,proto3" json:"plugin,omitempty"`
	Module *ModuleRef `protobuf:"bytes,2,opt,name=module,proto3" json:"module,omitempty"`
}
...
func (x *ResolveReferenceRequest) GetPlugin() *PluginRef {
	if x != nil {
		return x.Plugin
	}
	return nil
...
func (x *ResolveReferenceRequest) GetModule() *ModuleRef {
	if x != nil {
		return x.Module
	}
	return nil
...
func (x *ModuleRef) GetRepository() string {
	if x != nil {
		return x.Repository
	}
	return ""
...
func (x *ModuleRef) GetReference() string {
	if x != nil {
		return x.Reference
	}
	return ""
...
var file_buf_alpha_registry_v1alpha1_resolve_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x6e, 0x22, 0x5f, 0x0a, 0x09, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x52, 0x65, 0x66, 0x12,
	...
	0x6e, 0x63, 0x65, 0x22, 0x34, 0x0a, 0x18, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x52, 0x65,
...
var file_buf_alpha_registry_v1alpha1_resolve_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_buf_alpha_registry_v1alpha1_resolve_proto_goTypes = []interface{}{
	...
	(*ModuleRef)(nil),                  // 8: buf.alpha.registry.v1alpha1.ModuleRef
	(*ResolveReferenceResponse)(nil),   // 9: buf.alpha.registry.v1alpha1.ResolveReferenceResponse
	(*v1alpha1.ModuleReference)(nil),   // 10: buf.alpha.module.v1alpha1.ModuleReference
	(*v1alpha1.ModulePin)(nil),         // 11: buf.alpha.module.v1alpha1.ModulePin
	(*LocalModuleReference)(nil),       // 12: buf.alpha.registry.v1alpha1.LocalModuleReference
	(*LocalModulePin)(nil),             // 13: buf.alpha.registry.v1alpha1.LocalModulePin
}
var file_buf_alpha_registry_v1alpha1_resolve_proto_depIdxs = []int32{
	10, // 0: buf.alpha.registry.v1alpha1.GetModulePinsRequest.module_references:type_name -> buf.alpha.module.v1alpha1.ModuleReference
	11, // 1: buf.alpha.registry.v1alpha1.GetModulePinsRequest.current_module_pins:type_name -> buf.alpha.module.v1alpha1.ModulePin
	11, // 2: buf.alpha.registry.v1alpha1.GetModulePinsResponse.module_pins:type_name -> buf.alpha.module.v1alpha1.ModulePin
	12, // 3: buf.alpha.registry.v1alpha1.GetLocalModulePinsRequest.local_module_references:type_name -> buf.alpha.registry.v1alpha1.LocalModuleReference
	12, // 4: buf.alpha.registry.v1alpha1.LocalModuleResolveResult.reference:type_name -> buf.alpha.registry.v1alpha1.LocalModuleReference
	13, // 5: buf.alpha.registry.v1alpha1.LocalModuleResolveResult.pin:type_name -> buf.alpha.registry.v1alpha1.LocalModulePin
	...
	11, // 8: buf.alpha.registry.v1alpha1.GetLocalModulePinsResponse.dependencies:type_name -> buf.alpha.module.v1alpha1.ModulePin
	7,  // 9: buf.alpha.registry.v1alpha1.ResolveReferenceRequest.plugin:type_name -> buf.alpha.registry.v1alpha1.PluginRef
	8,  // 10: buf.alpha.registry.v1alpha1.ResolveReferenceRequest.module:type_name -> buf.alpha.registry.v1alpha1.ModuleRef
	...
	9,  // 15: buf.alpha.registry.v1alpha1.ResolveService.ResolveReference:output_type -> buf.alpha.registry.v1alpha1.ResolveReferenceResponse
