...
func (x *Owner) MarshalWithDescriptorInfo() ([]byte, error) {
	...
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.registry.v1alpha1.Owner",
			},
		},
	)
	if err != nil {
...
func (x *GetOwnerByNameRequest) MarshalWithDescriptorInfo() ([]byte, error) {
	bytes, err := proto.Marshal(x)
	if err != nil {
		return nil, err
	}
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.registry.v1alpha1.GetOwnerByNameRequest",
			},
		},
	)
	if err != nil {
...
func (x *GetOwnerByNameResponse) MarshalWithDescriptorInfo() ([]byte, error) {
	bytes, err := proto.Marshal(x)
	if err != nil {
		return nil, err
	}
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.registry.v1alpha1.GetOwnerByNameResponse",
			},
		},
	)
	if err != nil {
