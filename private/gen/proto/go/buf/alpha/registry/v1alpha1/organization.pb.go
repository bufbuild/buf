...
type GetOrganizationSettingsResponse struct {
	...
	BreakingChangeEnforcement bool `protobuf:"varint,6,opt,name=breaking_change_enforcement,json=breakingChangeEnforcement,proto3" json:"breaking_change_enforcement,omitempty"`
}
...
var file_buf_alpha_registry_v1alpha1_organization_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x19, 0x62, 0x72, 0x65, 0x61,
