...
var file_buf_alpha_registry_v1alpha1_organization_proto_depIdxs = []int32{
	...
	30, // 11: buf.alpha.registry.v1alpha1.AddOrganizationBaseRepositoryScopeRequest.repository_scope:type_name -> buf.alpha.registry.v1alpha1.RepositoryScope
	29, // 12: buf.alpha.registry.v1alpha1.AddOrganizationMemberRequest.organization_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	29, // 13: buf.alpha.registry.v1alpha1.UpdateOrganizationMemberRequest.organization_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	...
	3,  // 27: buf.alpha.registry.v1alpha1.OrganizationService.GetOrganization:output_type -> buf.alpha.registry.v1alpha1.GetOrganizationResponse
	5,  // 28: buf.alpha.registry.v1alpha1.OrganizationService.GetOrganizationByName:output_type -> buf.alpha.registry.v1alpha1.GetOrganizationByNameResponse
	7,  // 29: buf.alpha.registry.v1alpha1.OrganizationService.ListOrganizations:output_type -> buf.alpha.registry.v1alpha1.ListOrganizationsResponse
	9,  // 30: buf.alpha.registry.v1alpha1.OrganizationService.ListUserOrganizations:output_type -> buf.alpha.registry.v1alpha1.ListUserOrganizationsResponse
	11, // 31: buf.alpha.registry.v1alpha1.OrganizationService.CreateOrganization:output_type -> buf.alpha.registry.v1alpha1.CreateOrganizationResponse
	13, // 32: buf.alpha.registry.v1alpha1.OrganizationService.UpdateOrganizationName:output_type -> buf.alpha.registry.v1alpha1.UpdateOrganizationNameResponse
	15, // 33: buf.alpha.registry.v1alpha1.OrganizationService.UpdateOrganizationNameByName:output_type -> buf.alpha.registry.v1alpha1.UpdateOrganizationNameByNameResponse
	17, // 34: buf.alpha.registry.v1alpha1.OrganizationService.DeleteOrganization:output_type -> buf.alpha.registry.v1alpha1.DeleteOrganizationResponse
	19, // 35: buf.alpha.registry.v1alpha1.OrganizationService.DeleteOrganizationByName:output_type -> buf.alpha.registry.v1alpha1.DeleteOrganizationByNameResponse
	21, // 36: buf.alpha.registry.v1alpha1.OrganizationService.AddOrganizationBaseRepositoryScope:output_type -> buf.alpha.registry.v1alpha1.AddOrganizationBaseRepositoryScopeResponse
	23, // 37: buf.alpha.registry.v1alpha1.OrganizationService.AddOrganizationMember:output_type -> buf.alpha.registry.v1alpha1.AddOrganizationMemberResponse
	25, // 38: buf.alpha.registry.v1alpha1.OrganizationService.UpdateOrganizationMember:output_type -> buf.alpha.registry.v1alpha1.UpdateOrganizationMemberResponse
	27, // 39: buf.alpha.registry.v1alpha1.OrganizationService.RemoveOrganizationMember:output_type -> buf.alpha.registry.v1alpha1.RemoveOrganizationMemberResponse
