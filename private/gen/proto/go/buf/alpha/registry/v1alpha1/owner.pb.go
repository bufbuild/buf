...
type GetOwnersByIDRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// IDs of the requested owners.
	Ids []string `protobuf:"bytes,1,rep,name=ids,proto3" json:"ids,omitempty"`
}

func (x *GetOwnersByIDRequest) Reset() {
	*x = GetOwnersByIDRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_alpha_registry_v1alpha1_owner_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetOwnersByIDRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOwnersByIDRequest) ProtoMessage() {}

func (x *GetOwnersByIDRequest) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_owner_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOwnersByIDRequest.ProtoReflect.Descriptor instead.
func (*GetOwnersByIDRequest) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_owner_proto_rawDescGZIP(), []int{3}
}

func (x *GetOwnersByIDRequest) GetIds() []string {
	if x != nil {
		return x.Ids
	}
	return nil
...
type GetOwnersByIDResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Owners with the requested IDs.
	Owners []*Owner `protobuf:"bytes,1,rep,name=owners,proto3" json:"owners,omitempty"`
}

func (x *GetOwnersByIDResponse) Reset() {
	*x = GetOwnersByIDResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_alpha_registry_v1alpha1_owner_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetOwnersByIDResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOwnersByIDResponse) ProtoMessage() {}

func (x *GetOwnersByIDResponse) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_owner_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOwnersByIDResponse.ProtoReflect.Descriptor instead.
func (*GetOwnersByIDResponse) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_owner_proto_rawDescGZIP(), []int{4}
}

func (x *GetOwnersByIDResponse) GetOwners() []*Owner {
	if x != nil {
		return x.Owners
	}
	return nil
...
var file_buf_alpha_registry_v1alpha1_owner_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2e,
	0x62, 0x75, 0x66, 0x2f, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74,
	0x72, 0x79, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x6f, 0x72, 0x67, 0x61,
	0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9a,
	...
	,
	...
	,
	...
	0x68, 0x61, 0x31, 0x42, 0x0a, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var file_buf_alpha_registry_v1alpha1_owner_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_buf_alpha_registry_v1alpha1_owner_proto_goTypes = []interface{}{
	...
	(*GetOwnersByIDRequest)(nil),   // 3: buf.alpha.registry.v1alpha1.GetOwnersByIDRequest
	(*GetOwnersByIDResponse)(nil),  // 4: buf.alpha.registry.v1alpha1.GetOwnersByIDResponse
	(*User)(nil),                   // 5: buf.alpha.registry.v1alpha1.User
	(*Organization)(nil),           // 6: buf.alpha.registry.v1alpha1.Organization
}
var file_buf_alpha_registry_v1alpha1_owner_proto_depIdxs = []int32{
	5, // 0: buf.alpha.registry.v1alpha1.Owner.user:type_name -> buf.alpha.registry.v1alpha1.User
	6, // 1: buf.alpha.registry.v1alpha1.Owner.organization:type_name -> buf.alpha.registry.v1alpha1.Organization
	0, // 2: buf.alpha.registry.v1alpha1.GetOwnerByNameResponse.owner:type_name -> buf.alpha.registry.v1alpha1.Owner
	0, // 3: buf.alpha.registry.v1alpha1.GetOwnersByIDResponse.owners:type_name -> buf.alpha.registry.v1alpha1.Owner
	1, // 4: buf.alpha.registry.v1alpha1.OwnerService.GetOwnerByName:input_type -> buf.alpha.registry.v1alpha1.GetOwnerByNameRequest
	3, // 5: buf.alpha.registry.v1alpha1.OwnerService.GetOwnersByID:input_type -> buf.alpha.registry.v1alpha1.GetOwnersByIDRequest
	2, // 6: buf.alpha.registry.v1alpha1.OwnerService.GetOwnerByName:output_type -> buf.alpha.registry.v1alpha1.GetOwnerByNameResponse
	4, // 7: buf.alpha.registry.v1alpha1.OwnerService.GetOwnersByID:output_type -> buf.alpha.registry.v1alpha1.GetOwnersByIDResponse
...
func file_buf_alpha_registry_v1alpha1_owner_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_alpha_registry_v1alpha1_owner_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetOwnersByIDRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_alpha_registry_v1alpha1_owner_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetOwnersByIDResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
