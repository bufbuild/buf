...
func (x *LocalModuleReference) MarshalWithDescriptorInfo() ([]byte, error) {
	...
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.registry.v1alpha1.LocalModuleReference",
			},
		},
	)
	if err != nil {
...
func (x *LocalModulePin) MarshalWithDescriptorInfo() ([]byte, error) {
	bytes, err := proto.Marshal(x)
	if err != nil {
		return nil, err
	}
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.registry.v1alpha1.LocalModulePin",
			},
		},
	)
	if err != nil {
