...
type CountRepositoryTracksRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The ID of the repository whose tracks should be counted.
	RepositoryId string `protobuf:"bytes,1,opt,name=repository_id,json=repositoryId,proto3" json:"repository_id,omitempty"`
}

func (x *CountRepositoryTracksRequest) Reset() {
	*x = CountRepositoryTracksRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CountRepositoryTracksRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CountRepositoryTracksRequest) ProtoMessage() {}

func (x *CountRepositoryTracksRequest) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_repository_track_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CountRepositoryTracksRequest.ProtoReflect.Descriptor instead.
func (*CountRepositoryTracksRequest) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_repository_track_proto_rawDescGZIP(), []int{9}
}

func (x *CountRepositoryTracksRequest) GetRepositoryId() string {
	if x != nil {
		return x.RepositoryId
	}
	return ""
...
type CountRepositoryTracksResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CountRepositoryTracksResponse) Reset() {
	*x = CountRepositoryTracksResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CountRepositoryTracksResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CountRepositoryTracksResponse) ProtoMessage() {}

func (x *CountRepositoryTracksResponse) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_repository_track_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CountRepositoryTracksResponse.ProtoReflect.Descriptor instead.
func (*CountRepositoryTracksResponse) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_repository_track_proto_rawDescGZIP(), []int{10}
}

func (x *CountRepositoryTracksResponse) GetTotalCount() uint32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
var file_buf_alpha_registry_v1alpha1_repository_track_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x22, 0x43,
	0x0a, 0x1c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72,
	0x79, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x23,
	...
	0x79, 0x49, 0x64, 0x22, 0x40, 0x0a, 0x1d, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x52, 0x65, 0x73, 0x70,
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x85, 0x06, 0x0a, 0x16, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x6f, 0x72, 0x79, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x
 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0xa1, 0x02,
...
var file_buf_alpha_registry_v1alpha1_repository_track_proto_goTypes = []interface{}{
	...
	(*CountRepositoryTracksRequest)(nil),        // 9: buf.alpha.registry.v1alpha1.CountRepositoryTracksRequest
	(*CountRepositoryTracksResponse)(nil),       // 10: buf.alpha.registry.v1alpha1.CountRepositoryTracksResponse
...
var file_buf_alpha_registry_v1alpha1_repository_track_proto_depIdxs = []int32{
	...
	1,  // 4: buf.alpha.registry.v1alpha1.RepositoryTrackService.CreateRepositoryTrack:input_type -> buf.alpha.registry.v1alpha1.CreateRepositoryTrackRequest
	3,  // 5: buf.alpha.registry.v1alpha1.RepositoryTrackService.ListRepositoryTracks:input_type -> buf.alpha.registry.v1alpha1.ListRepositoryTracksRequest
	5,  // 6: buf.alpha.registry.v1alpha1.RepositoryTrackService.DeleteRepositoryTrackByName:input_type -> buf.alpha.registry.v1alpha1.DeleteRepositoryTrackByNameRequest
	7,  // 7: buf.alpha.registry.v1alpha1.RepositoryTrackService.GetRepositoryTrackByName:input_type -> buf.alpha.registry.v1alpha1.GetRepositoryTrackByNameRequest
	9,  // 8: buf.alpha.registry.v1alpha1.RepositoryTrackService.CountRepositoryTracks:input_type -> buf.alpha.registry.v1alpha1.CountRepositoryTracksRequest
	2,  // 9: buf.alpha.registry.v1alpha1.RepositoryTrackService.CreateRepositoryTrack:output_type -> buf.alpha.registry.v1alpha1.CreateRepositoryTrackResponse
	4,  // 10: buf.alpha.registry.v1alpha1.RepositoryTrackService.ListRepositoryTracks:output_type -> buf.alpha.registry.v1alpha1.ListRepositoryTracksResponse
	6,  // 11: buf.alpha.registry.v1alpha1.RepositoryTrackService.DeleteRepositoryTrackByName:output_type -> buf.alpha.registry.v1alpha1.DeleteRepositoryTrackByNameResponse
	8,  // 12: buf.alpha.registry.v1alpha1.RepositoryTrackService.GetRepositoryTrackByName:output_type -> buf.alpha.registry.v1alpha1.GetRepositoryTrackByNameResponse
	10, // 13: buf.alpha.registry.v1alpha1.RepositoryTrackService.CountRepositoryTracks:output_type -> buf.alpha.registry.v1alpha1.CountRepositoryTracksResponse
...
func file_buf_alpha_registry_v1alpha1_repository_track_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_alpha_registry_v1alpha1_repository_track_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CountRepositoryTracksRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_alpha_registry_v1alpha1_repository_track_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CountRepositoryTracksResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
