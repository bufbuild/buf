...
var file_buf_alpha_registry_v1alpha1_user_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xa5, 0x0a, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x63, 0x6f, 0x70, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x96, 0x02, 0x0a,
...
var file_buf_alpha_registry_v1alpha1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_buf_alpha_registry_v1alpha1_user_proto_goTypes = []interface{}{
	...
	(OrganizationScope)(0),                         // 22: buf.alpha.registry.v1alpha1.OrganizationScope
}
var file_buf_alpha_registry_v1alpha1_user_proto_depIdxs = []int32{
	...
	22, // 8: buf.alpha.registry.v1alpha1.AddUserOrganizationScopeByNameRequest.organization_scope:type_name -> buf.alpha.registry.v1alpha1.OrganizationScope
	22, // 9: buf.alpha.registry.v1alpha1.RemoveUserOrganizationScopeRequest.organization_scope:type_name -> buf.alpha.registry.v1alpha1.OrganizationScope
	1,  // 10: buf.alpha.registry.v1alpha1.UserService.CreateUser:input_type -> buf.alpha.registry.v1alpha1.CreateUserRequest
	3,  // 11: buf.alpha.registry.v1alpha1.UserService.GetUser:input_type -> buf.alpha.registry.v1alpha1.GetUserRequest
	5,  // 12: buf.alpha.registry.v1alpha1.UserService.GetUserByUsername:input_type -> buf.alpha.registry.v1alpha1.GetUserByUsernameRequest
	7,  // 13: buf.alpha.registry.v1alpha1.UserService.ListUsers:input_type -> buf.alpha.registry.v1alpha1.ListUsersRequest
	9,  // 14: buf.alpha.registry.v1alpha1.UserService.ListOrganizationUsers:input_type -> buf.alpha.registry.v1alpha1.ListOrganizationUsersRequest
	11, // 15: buf.alpha.registry.v1alpha1.UserService.UpdateUserUsername:input_type -> buf.alpha.registry.v1alpha1.UpdateUserUsernameRequest
	13, // 16: buf.alpha.registry.v1alpha1.UserService.DeleteUser:input_type -> buf.alpha.registry.v1alpha1.DeleteUserRequest
	15, // 17: buf.alpha.registry.v1alpha1.UserService.DeactivateUser:input_type -> buf.alpha.registry.v1alpha1.DeactivateUserRequest
	17, // 18: buf.alpha.registry.v1alpha1.UserService.AddUserOrganizationScopeByName:input_type -> buf.alpha.registry.v1alpha1.AddUserOrganizationScopeByNameRequest
	19, // 19: buf.alpha.registry.v1alpha1.UserService.RemoveUserOrganizationScope:input_type -> buf.alpha.registry.v1alpha1.RemoveUserOrganizationScopeRequest
	2,  // 20: buf.alpha.registry.v1alpha1.UserService.CreateUser:output_type -> buf.alpha.registry.v1alpha1.CreateUserResponse
	4,  // 21: buf.alpha.registry.v1alpha1.UserService.GetUser:output_type -> buf.alpha.registry.v1alpha1.GetUserResponse
	6,  // 22: buf.alpha.registry.v1alpha1.UserService.GetUserByUsername:output_type -> buf.alpha.registry.v1alpha1.GetUserByUsernameResponse
	8,  // 23: buf.alpha.registry.v1alpha1.UserService.ListUsers:output_type -> buf.alpha.registry.v1alpha1.ListUsersResponse
	10, // 24: buf.alpha.registry.v1alpha1.UserService.ListOrganizationUsers:output_type -> buf.alpha.registry.v1alpha1.ListOrganizationUsersResponse
	12, // 25: buf.alpha.registry.v1alpha1.UserService.UpdateUserUsername:output_type -> buf.alpha.registry.v1alpha1.UpdateUserUsernameResponse
	...
	18, // 28: buf.alpha.registry.v1alpha1.UserService.AddUserOrganizationScopeByName:output_type -> buf.alpha.registry.v1alpha1.AddUserOrganizationScopeByNameResponse
	20, // 29: buf.alpha.registry.v1alpha1.UserService.RemoveUserOrganizationScope:output_type -> buf.alpha.registry.v1alpha1.RemoveUserOrganizationScopeResponse
