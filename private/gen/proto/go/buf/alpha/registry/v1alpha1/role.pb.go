...
const (
	...
	OrganizationRole_ORGANIZATION_ROLE_MEMBER      OrganizationRole = 1
	OrganizationRole_ORGANIZATION_ROLE_ADMIN       OrganizationRole = 2
	OrganizationRole_ORGANIZATION_ROLE_OWNER       OrganizationRole = 3
)
...
const (
	...
	RepositoryRole_REPOSITORY_ROLE_READ        RepositoryRole = 1
	RepositoryRole_REPOSITORY_ROLE_WRITE       RepositoryRole = 2
	RepositoryRole_REPOSITORY_ROLE_ADMIN       RepositoryRole = 3
	RepositoryRole_REPOSITORY_ROLE_OWNER       RepositoryRole = 4
)
...
var (
	RepositoryRole_name = map[int32]string{
		...
		1: "REPOSITORY_ROLE_READ",
		2: "REPOSITORY_ROLE_WRITE",
		3: "REPOSITORY_ROLE_ADMIN",
		4: "REPOSITORY_ROLE_OWNER",
	}
	RepositoryRole_value = map[string]int32{
		"REPOSITORY_ROLE_UNSPECIFIED": 0,
		"REPOSITORY_ROLE_READ":        1,
		"REPOSITORY_ROLE_WRITE":       2,
		"REPOSITORY_ROLE_ADMIN":       3,
		"REPOSITORY_ROLE_OWNER":       4,
	}
)
...
const (
	...
	TemplateRole_TEMPLATE_ROLE_READ        TemplateRole = 1
	TemplateRole_TEMPLATE_ROLE_WRITE       TemplateRole = 2
	TemplateRole_TEMPLATE_ROLE_ADMIN       TemplateRole = 3
	TemplateRole_TEMPLATE_ROLE_OWNER       TemplateRole = 4
)
...
var (
	TemplateRole_name = map[int32]string{
		...
		1: "TEMPLATE_ROLE_READ",
		2: "TEMPLATE_ROLE_WRITE",
		3: "TEMPLATE_ROLE_ADMIN",
		4: "TEMPLATE_ROLE_OWNER",
	}
	TemplateRole_value = map[string]int32{
		"TEMPLATE_ROLE_UNSPECIFIED": 0,
		"TEMPLATE_ROLE_READ":        1,
		"TEMPLATE_ROLE_WRITE":       2,
		"TEMPLATE_ROLE_ADMIN":       3,
		"TEMPLATE_ROLE_OWNER":       4,
	}
)
...
const (
	...
	PluginRole_PLUGIN_ROLE_READ        PluginRole = 1
	PluginRole_PLUGIN_ROLE_WRITE       PluginRole = 2
	PluginRole_PLUGIN_ROLE_ADMIN       PluginRole = 3
	PluginRole_PLUGIN_ROLE_OWNER       PluginRole = 4
)
...
var file_buf_alpha_registry_v1alpha1_role_proto_rawDesc = []byte{
	...
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1c, 0x0a, 0x18, 0x4f, 0x52, 0x47, 0x41, 0x4e,
	0x49, 0x5a, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x4f, 0x4c, 0x45, 0x5f, 0x4d, 0x45, 0x4d,
	0x42, 0x45, 0x52, 0x10, 0x01, 0x12, 0x1b, 0x0a, 0x17, 0x4f, 0x52, 0x47, 0x41, 0x4e, 0x49, 0x5a,
	0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x4f, 0x4c, 0x45, 0x5f, 0x41, 0x44, 0x4d, 0x49, 0x4e,
	0x10, 0x02, 0x12, 0x1b, 0x0a, 0x17, 0x4f, 0x52, 0x47, 0x41, 0x4e, 0x49, 0x5a, 0x41, 0x54, 0x49,
	0x4f, 0x4e, 0x5f, 0x52, 0x4f, 0x4c, 0x45, 0x5f, 0x4f, 0x57, 0x4e, 0x45, 0x52, 0x10, 0x03, 0x2a,
	...
	,
