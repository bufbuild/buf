...
type GetRepositoryTrackCommitByCommitReferenceRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	RepositoryTrackName string `protobuf:"bytes,2,opt,name=repository_track_name,json=repositoryTrackName,proto3" json:"repository_track_name,omitempty"`
	// The commit reference to resolve.
	Commit string `protobuf:"bytes,3,opt,name=commit,proto3" json:"commit,omitempty"`
}

func (x *GetRepositoryTrackCommitByCommitReferenceRequest) Reset() {
	*x = GetRepositoryTrackCommitByCommitReferenceRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetRepositoryTrackCommitByCommitReferenceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRepositoryTrackCommitByCommitReferenceRequest) ProtoMessage() {}

func (x *GetRepositoryTrackCommitByCommitReferenceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRepositoryTrackCommitByCommitReferenceRequest.ProtoReflect.Descriptor instead.
func (*GetRepositoryTrackCommitByCommitReferenceRequest) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_rawDescGZIP(), []int{1}
}

func (x *GetRepositoryTrackCommitByCommitReferenceRequest) GetRepositoryId() string {
	if x != nil {
...
func (x *GetRepositoryTrackCommitByCommitReferenceRequest) GetRepositoryTrackName() string {
	if x != nil {
...
func (x *GetRepositoryTrackCommitByCommitReferenceRequest) GetCommit() string {
	if x != nil {
		return x.Commit
	}
	return ""
...
type GetRepositoryTrackCommitByCommitReferenceResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetRepositoryTrackCommitByCommitReferenceResponse) Reset() {
	*x = GetRepositoryTrackCommitByCommitReferenceResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetRepositoryTrackCommitByCommitReferenceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRepositoryTrackCommitByCommitReferenceResponse) ProtoMessage() {}

func (x *GetRepositoryTrackCommitByCommitReferenceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRepositoryTrackCommitByCommitReferenceResponse.ProtoReflect.Descriptor instead.
func (*GetRepositoryTrackCommitByCommitReferenceResponse) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_rawDescGZIP(), []int{2}
}

func (x *GetRepositoryTrackCommitByCommitReferenceResponse) GetRepositoryTrackCommit() *RepositoryTrackCommit {
	if x != nil {
...
func (x *ListRepositoryTrackCommitsByRepositoryTrackRequest) GetRepositoryId() string {
	if x != nil {
		return x.RepositoryId
	}
	return ""
...
func (x *ListRepositoryTrackCommitsByRepositoryTrackRequest) GetRepositoryTrackName() string {
	if x != nil {
		return x.RepositoryTrackName
	}
	return ""
...
var file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_rawDesc = []byte{
	...
	0x65, 0x49, 0x64, 0x22, 0xa3, 0x01, 0x0a, 0x30, 0x47, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x73,
	0x69, 0x74, 0x6f, 0x72, 0x79, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x4e, 0x2e,
	...
	0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x43, 0x6f,
	0x6d, 0x6d, 0x69, 0x74, 0x42, 0x79, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0xd0, 0x01,
	...
	0x42, 0xa7, 0x02, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x31, 0x42, 0x1a, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79,
	0x54, 0x72, 0x61, 0x63, 0x6b, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_goTypes = []interface{}{
	...
	(*GetRepositoryTrackCommitByCommitReferenceRequest)(nil),    // 1: buf.alpha.registry.v1alpha1.GetRepositoryTrackCommitByCommitReferenceRequest
	(*GetRepositoryTrackCommitByCommitReferenceResponse)(nil),   // 2: buf.alpha.registry.v1alpha1.GetRepositoryTrackCommitByCommitReferenceResponse
...
var file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_depIdxs = []int32{
	5, // 0: buf.alpha.registry.v1alpha1.RepositoryTrackCommit.create_time:type_name -> google.protobuf.Timestamp
	0, // 1: buf.alpha.registry.v1alpha1.GetRepositoryTrackCommitByCommitReferenceResponse.repository_track_commit:type_name -> buf.alpha.registry.v1alpha1.RepositoryTrackCommit
	...
	1, // 3: buf.alpha.registry.v1alpha1.RepositoryTrackCommitService.GetRepositoryTrackCommitByCommitReference:input_type -> buf.alpha.registry.v1alpha1.GetRepositoryTrackCommitByCommitReferenceRequest
	3, // 4: buf.alpha.registry.v1alpha1.RepositoryTrackCommitService.ListRepositoryTrackCommitsByRepositoryTrack:input_type -> buf.alpha.registry.v1alpha1.ListRepositoryTrackCommitsByRepositoryTrackRequest
	2, // 5: buf.alpha.registry.v1alpha1.RepositoryTrackCommitService.GetRepositoryTrackCommitByCommitReference:output_type -> buf.alpha.registry.v1alpha1.GetRepositoryTrackCommitByCommitReferenceResponse
	4, // 6: buf.alpha.registry.v1alpha1.RepositoryTrackCommitService.ListRepositoryTrackCommitsByRepositoryTrack:output_type -> buf.alpha.registry.v1alpha1.ListRepositoryTrackCommitsByRepositoryTrackResponse
...
func file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRepositoryTrackCommitByCommitReferenceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_alpha_registry_v1alpha1_repository_track_commit_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRepositoryTrackCommitByCommitReferenceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
