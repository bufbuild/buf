...
type ListBSRHeadHistoryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	PageSize       uint32 `protobuf:"varint,3,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
	PageToken      string `protobuf:"bytes,4,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// By default, draft commits are ordered by create time descending.
	// Reverse orders them ascending.
	Reverse bool `protobuf:"varint,5,opt,name=reverse,proto3" json:"reverse,omitempty"`
}

func (x *ListBSRHeadHistoryRequest) Reset() {
	*x = ListBSRHeadHistoryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListBSRHeadHistoryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBSRHeadHistoryRequest) ProtoMessage() {}

func (x *ListBSRHeadHistoryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_repository_commit_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBSRHeadHistoryRequest.ProtoReflect.Descriptor instead.
func (*ListBSRHeadHistoryRequest) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_repository_commit_proto_rawDescGZIP(), []int{11}
}

func (x *ListBSRHeadHistoryRequest) GetRepositoryOwner() string {
	if x != nil {
		return x.RepositoryOwner
	}
	return ""
...
func (x *ListBSRHeadHistoryRequest) GetRepositoryName() string {
	if x != nil {
		return x.RepositoryName
	}
	return ""
...
func (x *ListBSRHeadHistoryRequest) GetPageSize() uint32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListBSRHeadHistoryRequest) GetPageToken() string {
	if x != nil {
		return x.PageToken
	}
	return ""
...
func (x *ListBSRHeadHistoryRequest) GetReverse() bool {
	if x != nil {
		return x.Reverse
	}
	return false
...
type ListBSRHeadHistoryResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListBSRHeadHistoryResponse) Reset() {
	*x = ListBSRHeadHistoryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListBSRHeadHistoryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBSRHeadHistoryResponse) ProtoMessage() {}

func (x *ListBSRHeadHistoryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_repository_commit_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBSRHeadHistoryResponse.ProtoReflect.Descriptor instead.
func (*ListBSRHeadHistoryResponse) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_repository_commit_proto_rawDescGZIP(), []int{12}
}

func (x *ListBSRHeadHistoryResponse) GetRepositoryCommits() []*RepositoryCommit {
	if x != nil {
		return x.RepositoryCommits
	}
	return nil
...
func (x *ListBSRHeadHistoryResponse) GetNextPageToken() string {
	if x != nil {
		return x.NextPageToken
	}
	return ""
...
var file_buf_alpha_registry_v1alpha1_repository_commit_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xc5, 0x01, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74,
	0x42, 0x53, 0x52, 0x48, 0x65, 0x61, 0x64, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65,
	...
	0x69, 0x74, 0x6f, 0x72, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x67,
	...
	0xa2, 0x01, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x53, 0x52, 0x48, 0x65, 0x61, 0x64, 0x48,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x8c, 0x08, 0x0a, 0x17, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	...
	0x65, 0x22, 0x03, 0x90, 0x02, 0x02, 0x12, 0x8a, 0x01, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x42,
	0x53, 0x52, 0x48, 0x65, 0x61, 0x64, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x36, 0x2e,
	...
	0x61, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x53, 0x52, 0x48, 0x65, 0x61, 0x64, 0x48,
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03,
	0x90, 0x02, 0x01, 0x42, 0xa2, 0x02, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x75, 0x66, 0x2e,
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x15, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x6f, 0x72, 0x79, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var file_buf_alpha_registry_v1alpha1_repository_commit_proto_goTypes = []interface{}{
	...
	(*ListBSRHeadHistoryRequest)(nil),                // 11: buf.alpha.registry.v1alpha1.ListBSRHeadHistoryRequest
	(*ListBSRHeadHistoryResponse)(nil),               // 12: buf.alpha.registry.v1alpha1.ListBSRHeadHistoryResponse
...
var file_buf_alpha_registry_v1alpha1_repository_commit_proto_depIdxs = []int32{
	...
	0,  // 6: buf.alpha.registry.v1alpha1.ListBSRHeadHistoryResponse.repository_commits:type_name -> buf.alpha.registry.v1alpha1.RepositoryCommit
	...
	7,  // 10: buf.alpha.registry.v1alpha1.RepositoryCommitService.ListRepositoryDraftCommits:input_type -> buf.alpha.registry.v1alpha1.ListRepositoryDraftCommitsRequest
	9,  // 11: buf.alpha.registry.v1alpha1.RepositoryCommitService.DeleteRepositoryDraftCommit:input_type -> buf.alpha.registry.v1alpha1.DeleteRepositoryDraftCommitRequest
	11, // 12: buf.alpha.registry.v1alpha1.RepositoryCommitService.ListBSRHeadHistory:input_type -> buf.alpha.registry.v1alpha1.ListBSRHeadHistoryRequest
	...
	8,  // 16: buf.alpha.registry.v1alpha1.RepositoryCommitService.ListRepositoryDraftCommits:output_type -> buf.alpha.registry.v1alpha1.ListRepositoryDraftCommitsResponse
	10, // 17: buf.alpha.registry.v1alpha1.RepositoryCommitService.DeleteRepositoryDraftCommit:output_type -> buf.alpha.registry.v1alpha1.DeleteRepositoryDraftCommitResponse
	12, // 18: buf.alpha.registry.v1alpha1.RepositoryCommitService.ListBSRHeadHistory:output_type -> buf.alpha.registry.v1alpha1.ListBSRHeadHistoryResponse
...
func file_buf_alpha_registry_v1alpha1_repository_commit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_alpha_registry_v1alpha1_repository_commit_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListBSRHeadHistoryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_alpha_registry_v1alpha1_repository_commit_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListBSRHeadHistoryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
