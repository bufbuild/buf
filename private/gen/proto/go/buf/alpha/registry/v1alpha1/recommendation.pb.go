...
type RecommendedRepositoriesResponse struct {
	state                   protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Repositories *[]*RecommendedRepository `protobuf:"bytes,1,rep,name=repositories,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type SetRecommendedResourcesRequest struct {
	state                protoimpl.MessageState     `protogen:"opaque.v1"`
	xxx_hidden_Resources *[]*SetRecommendedResource `protobuf:"bytes,1,rep,name=resources,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
var file_buf_alpha_registry_v1alpha1_recommendation_proto_rawDesc = string([]byte{
...
func file_buf_alpha_registry_v1alpha1_recommendation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_buf_alpha_registry_v1alpha1_recommendation_proto_rawDesc), len(file_buf_alpha_registry_v1alpha1_recommendation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
