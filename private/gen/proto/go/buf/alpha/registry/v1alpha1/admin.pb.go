...
// MonthlyUsage contains the total amount of message, enum and method types
...
// RepositoryUsage contains the total amount of message, enum and method types
// for an repository within an organization.
type RepositoryUsage struct {
	...
	// The total amount of message types for the month and year.
	TotalMessageTypes uint32 `protobuf:"varint,5,opt,name=total_message_types,json=totalMessageTypes,proto3" json:"total_message_types,omitempty"`
	// The total amount of enum types for the month and year.
	TotalEnumTypes uint32 `protobuf:"varint,6,opt,name=total_enum_types,json=totalEnumTypes,proto3" json:"total_enum_types,omitempty"`
	// The total amount of method types for the month and year.
	TotalMethodTypes uint32 `protobuf:"varint,7,opt,name=total_method_types,json=totalMethodTypes,proto3" json:"total_method_types,omitempty"`
}
...
func (x *RepositoryUsage) GetRepositoryId() string {
	if x != nil {
...
func (x *RepositoryUsage) GetRepositoryName() string {
	if x != nil {
		return x.RepositoryName
	}
	return ""
...
func (x *RepositoryUsage) GetOwnerId() string {
	if x != nil {
		return x.OwnerId
	}
	return ""
...
func (x *RepositoryUsage) GetOwnerName() string {
	if x != nil {
		return x.OwnerName
	}
	return ""
...
func (x *RepositoryUsage) GetTotalMessageTypes() uint32 {
	if x != nil {
		return x.TotalMessageTypes
	}
	return 0
...
func (x *RepositoryUsage) GetTotalEnumTypes() uint32 {
	if x != nil {
		return x.TotalEnumTypes
	}
	return 0
...
func (x *RepositoryUsage) GetTotalMethodTypes() uint32 {
	if x != nil {
		return x.TotalMethodTypes
	}
	return 0
...
type GetClusterUsageRequest struct {
	...
	// Resource id is an optional owner or repository id used to filter usage.
	//
	// Types that are assignable to ResourceId:
	//
	//	*GetClusterUsageRequest_OwnerId
	//	*GetClusterUsageRequest_RepositoryId
	ResourceId isGetClusterUsageRequest_ResourceId `protobuf_oneof:"resource_id"`
}
...
func (m *GetClusterUsageRequest) GetResourceId() isGetClusterUsageRequest_ResourceId {
	if m != nil {
		return m.ResourceId
	}
	return nil
...
func (x *GetClusterUsageRequest) GetOwnerId() string {
	if x, ok := x.GetResourceId().(*GetClusterUsageRequest_OwnerId); ok {
		return x.OwnerId
	}
	return ""
}

func (x *GetClusterUsageRequest) GetRepositoryId() string {
	if x, ok := x.GetResourceId().(*GetClusterUsageRequest_RepositoryId); ok {
		return x.RepositoryId
	}
	return ""
}

type isGetClusterUsageRequest_ResourceId interface {
	isGetClusterUsageRequest_ResourceId()
}

type GetClusterUsageRequest_OwnerId struct {
	// The id of the owner.
	OwnerId string `protobuf:"bytes,3,opt,name=owner_id,json=ownerId,proto3,oneof"`
}

type GetClusterUsageRequest_RepositoryId struct {
	// The id of the repository.
	RepositoryId string `protobuf:"bytes,4,opt,name=repository_id,json=repositoryId,proto3,oneof"`
}

func (*GetClusterUsageRequest_OwnerId) isGetClusterUsageRequest_ResourceId() {}

func (*GetClusterUsageRequest_RepositoryId) isGetClusterUsageRequest_ResourceId() {}
...
func (x *GetClusterUsageResponse) Reset() {
	*x = GetClusterUsageResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetClusterUsageResponse) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_admin_proto_rawDescGZIP(), []int{32}
}
...
type ListRepositoriesUsageRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListRepositoriesUsageRequest) Reset() {
	*x = ListRepositoriesUsageRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ListRepositoriesUsageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRepositoriesUsageRequest) ProtoMessage() {}

func (x *ListRepositoriesUsageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRepositoriesUsageRequest.ProtoReflect.Descriptor instead.
func (*ListRepositoriesUsageRequest) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_admin_proto_rawDescGZIP(), []int{33}
}

func (x *ListRepositoriesUsageRequest) GetStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *ListRepositoriesUsageRequest) GetEndTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
type ListRepositoriesUsageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListRepositoriesUsageResponse) Reset() {
	*x = ListRepositoriesUsageResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ListRepositoriesUsageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRepositoriesUsageResponse) ProtoMessage() {}

func (x *ListRepositoriesUsageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRepositoriesUsageResponse.ProtoReflect.Descriptor instead.
func (*ListRepositoriesUsageResponse) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_admin_proto_rawDescGZIP(), []int{34}
}

func (x *ListRepositoriesUsageResponse) GetRepositoryUsages() []*RepositoryUsage {
	if x != nil {
		return x.RepositoryUsages
	}
	return nil
}
...
var file_buf_alpha_registry_v1alpha1_admin_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0xa1, 0x02, 0x0a, 0x0f, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72,
	0x79, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69,
	...
	,
	...
	0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x4f, 0x0a, 0x0d,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x60, 0x0a, 0x13, 0x76,
	...
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x26, 0x0a,
	0x24, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x56, 0x65, 0x72, 0x69, 0x66,
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0
 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3a, 0x2e, 0x62, 0x75, 0x66,
	0x2e, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x70,
	0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x55, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x97, 0x02, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x62,
	0x75, 0x66, 0x2e, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	0x79, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x0a, 0x41, 0x64, 0x6d, 0x69,
...
var file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_buf_alpha_registry_v1alpha1_admin_proto_goTypes = []interface{}{
	...
	(*RepositoryUsage)(nil),                              // 8: buf.alpha.registry.v1alpha1.RepositoryUsage
	(*ForceDeleteUserRequest)(nil),                       // 9: buf.alpha.registry.v1alpha1.ForceDeleteUserRequest
	(*ForceDeleteUserResponse)(nil),                      // 10: buf.alpha.registry.v1alpha1.ForceDeleteUserResponse
	(*UpdateUserVerificationStatusRequest)(nil),          // 11: buf.alpha.registry.v1alpha1.UpdateUserVerificationStatusRequest
	(*UpdateUserVerificationStatusResponse)(nil),         // 12: buf.alpha.registry.v1alpha1.UpdateUserVerificationStatusResponse
	(*UpdateOrganizationVerificationStatusRequest)(nil),  // 13: buf.alpha.registry.v1alpha1.UpdateOrganizationVerificationStatusRequest
	(*UpdateOrganizationVerificationStatusResponse)(nil), // 14: buf.alpha.registry.v1alpha1.UpdateOrganizationVerificationStatusResponse
	(*CreateMachineUserRequest)(nil),                     // 15: buf.alpha.registry.v1alpha1.CreateMachineUserRequest
	(*CreateMachineUserResponse)(nil),                    // 16: buf.alpha.registry.v1alpha1.CreateMachineUserResponse
	(*GetBreakingChangePolicyRequest)(nil),               // 17: buf.alpha.registry.v1alpha1.GetBreakingChangePolicyRequest
	(*GetBreakingChangePolicyResponse)(nil),              // 18: buf.alpha.registry.v1alpha1.GetBreakingChangePolicyResponse
	(*UpdateBreakingChangePolicyRequest)(nil),            // 19: buf.alpha.registry.v1alpha1.UpdateBreakingChangePolicyRequest
	(*UpdateBreakingChangePolicyResponse)(nil),           // 20: buf.alpha.registry.v1alpha1.UpdateBreakingChangePolicyResponse
	(*GetUniquenessPolicyRequest)(nil),                   // 21: buf.alpha.registry.v1alpha1.GetUniquenessPolicyRequest
	(*GetUniquenessPolicyResponse)(nil),                  // 22: buf.alpha.registry.v1alpha1.GetUniquenessPolicyResponse
	(*UpdateUniquenessPolicyRequest)(nil),                // 23: buf.alpha.registry.v1alpha1.UpdateUniquenessPolicyRequest
	(*UpdateUniquenessPolicyResponse)(nil),               // 24: buf.alpha.registry.v1alpha1.UpdateUniquenessPolicyResponse
	(*ListServerUniquenessCollisionsRequest)(nil),        // 25: buf.alpha.registry.v1alpha1.ListServerUniquenessCollisionsRequest
	(*ListServerUniquenessCollisionsResponse)(nil),       // 26: buf.alpha.registry.v1alpha1.ListServerUniquenessCollisionsResponse
	(*RunServerUniquenessBackfillTaskRequest)(nil),       // 27: buf.alpha.registry.v1alpha1.RunServerUniquenessBackfillTaskRequest
	(*RunServerUniquenessBackfillTaskResponse)(nil),      // 28: buf.alpha.registry.v1alpha1.RunServerUniquenessBackfillTaskResponse
	(*GetReviewFlowGracePeriodPolicyRequest)(nil),        // 29: buf.alpha.registry.v1alpha1.GetReviewFlowGracePeriodPolicyRequest
	(*GetReviewFlowGracePeriodPolicyResponse)(nil),       // 30: buf.alpha.registry.v1alpha1.GetReviewFlowGracePeriodPolicyResponse
	(*UpdateReviewFlowGracePeriodPolicyRequest)(nil),     // 31: buf.alpha.registry.v1alpha1.UpdateReviewFlowGracePeriodPolicyRequest
	(*UpdateReviewFlowGracePeriodPolicyResponse)(nil),    // 32: buf.alpha.registry.v1alpha1.UpdateReviewFlowGracePeriodPolicyResponse
	(*GetClusterUsageRequest)(nil),                       // 33: buf.alpha.registry.v1alpha1.GetClusterUsageRequest
	(*GetClusterUsageResponse)(nil),                      // 34: buf.alpha.registry.v1alpha1.GetClusterUsageResponse
	(*ListRepositoriesUsageRequest)(nil),                 // 35: buf.alpha.registry.v1alpha1.ListRepositoriesUsageRequest
	(*ListRepositoriesUsageResponse)(nil),                // 36: buf.alpha.registry.v1alpha1.ListRepositoriesUsageResponse
	(*User)(nil),                                         // 37: buf.alpha.registry.v1alpha1.User
	(*Organization)(nil),                                 // 38: buf.alpha.registry.v1alpha1.Organization
	(*Repository)(nil),                                   // 39: buf.alpha.registry.v1alpha1.Repository
	(VerificationStatus)(0),                              // 40: buf.alpha.registry.v1alpha1.VerificationStatus
...
var file_buf_alpha_registry_v1alpha1_admin_proto_depIdxs = []int32{
	...
	37, // 3: buf.alpha.registry.v1alpha1.ForceDeleteUserResponse.user:type_name -> buf.alpha.registry.v1alpha1.User
	38, // 4: buf.alpha.registry.v1alpha1.ForceDeleteUserResponse.organizations:type_name -> buf.alpha.registry.v1alpha1.Organization
	39, // 5: buf.alpha.registry.v1alpha1.ForceDeleteUserResponse.repositories:type_name -> buf.alpha.registry.v1alpha1.Repository
	40, // 6: buf.alpha.registry.v1alpha1.UpdateUserVerificationStatusRequest.verification_status:type_name -> buf.alpha.registry.v1alpha1.VerificationStatus
	40, // 7: buf.alpha.registry.v1alpha1.UpdateOrganizationVerificationStatusRequest.verification_status:type_name -> buf.alpha.registry.v1alpha1.VerificationStatus
	37, // 8: buf.alpha.registry.v1alpha1.CreateMachineUserResponse.user:type_name -> buf.alpha.registry.v1alpha1.User
	...
	41, // 17: buf.alpha.registry.v1alpha1.GetClusterUsageRequest.start_time:type_name -> google.protobuf.Timestamp
	41, // 18: buf.alpha.registry.v1alpha1.GetClusterUsageRequest.end_time:type_name -> google.protobuf.Timestamp
	7,  // 19: buf.alpha.registry.v1alpha1.GetClusterUsageResponse.usage:type_name -> buf.alpha.registry.v1alpha1.MonthlyUsage
	41, // 20: buf.alpha.registry.v1alpha1.ListRepositoriesUsageRequest.start_time:type_name -> google.protobuf.Timestamp
	41, // 21: buf.alpha.registry.v1alpha1.ListRepositoriesUsageRequest.end_time:type_name -> google.protobuf.Timestamp
	8,  // 22: buf.alpha.registry.v1alpha1.ListRepositoriesUsageResponse.repository_usages:type_name -> buf.alpha.registry.v1alpha1.RepositoryUsage
	9,  // 23: buf.alpha.registry.v1alpha1.AdminService.ForceDeleteUser:input_type -> buf.alpha.registry.v1alpha1.ForceDeleteUserRequest
	11, // 24: buf.alpha.registry.v1alpha1.AdminService.UpdateUserVerificationStatus:input_type -> buf.alpha.registry.v1alpha1.UpdateUserVerificationStatusRequest
	13, // 25: buf.alpha.registry.v1alpha1.AdminService.UpdateOrganizationVerificationStatus:input_type -> buf.alpha.registry.v1alpha1.UpdateOrganizationVerificationStatusRequest
	15, // 26: buf.alpha.registry.v1alpha1.AdminService.CreateMachineUser:input_type -> buf.alpha.registry.v1alpha1.CreateMachineUserRequest
	17, // 27: buf.alpha.registry.v1alpha1.AdminService.GetBreakingChangePolicy:input_type -> buf.alpha.registry.v1alpha1.GetBreakingChangePolicyRequest
	19, // 28: buf.alpha.registry.v1alpha1.AdminService.UpdateBreakingChangePolicy:input_type -> buf.alpha.registry.v1alpha1.UpdateBreakingChangePolicyRequest
	21, // 29: buf.alpha.registry.v1alpha1.AdminService.GetUniquenessPolicy:input_type -> buf.alpha.registry.v1alpha1.GetUniquenessPolicyRequest
	23, // 30: buf.alpha.registry.v1alpha1.AdminService.UpdateUniquenessPolicy:input_type -> buf.alpha.registry.v1alpha1.UpdateUniquenessPolicyRequest
	25, // 31: buf.alpha.registry.v1alpha1.AdminService.ListServerUniquenessCollisions:input_type -> buf.alpha.registry.v1alpha1.ListServerUniquenessCollisionsRequest
	27, // 32: buf.alpha.registry.v1alpha1.AdminService.RunServerUniquenessBackfillTask:input_type -> buf.alpha.registry.v1alpha1.RunServerUniquenessBackfillTaskRequest
	29, // 33: buf.alpha.registry.v1alpha1.AdminService.GetReviewFlowGracePeriodPolicy:input_type -> buf.alpha.registry.v1alpha1.GetReviewFlowGracePeriodPolicyRequest
	31, // 34: buf.alpha.registry.v1alpha1.AdminService.UpdateReviewFlowGracePeriodPolicy:input_type -> buf.alpha.registry.v1alpha1.UpdateReviewFlowGracePeriodPolicyRequest
	33, // 35: buf.alpha.registry.v1alpha1.AdminService.GetClusterUsage:input_type -> buf.alpha.registry.v1alpha1.GetClusterUsageRequest
	35, // 36: buf.alpha.registry.v1alpha1.AdminService.ListRepositoriesUsage:input_type -> buf.alpha.registry.v1alpha1.ListRepositoriesUsageRequest
	10, // 37: buf.alpha.registry.v1alpha1.AdminService.ForceDeleteUser:output_type -> buf.alpha.registry.v1alpha1.ForceDeleteUserResponse
	12, // 38: buf.alpha.registry.v1alpha1.AdminService.UpdateUserVerificationStatus:output_type -> buf.alpha.registry.v1alpha1.UpdateUserVerificationStatusResponse
	14, // 39: buf.alpha.registry.v1alpha1.AdminService.UpdateOrganizationVerificationStatus:output_type -> buf.alpha.registry.v1alpha1.UpdateOrganizationVerificationStatusResponse
	16, // 40: buf.alpha.registry.v1alpha1.AdminService.CreateMachineUser:output_type -> buf.alpha.registry.v1alpha1.CreateMachineUserResponse
	18, // 41: buf.alpha.registry.v1alpha1.AdminService.GetBreakingChangePolicy:output_type -> buf.alpha.registry.v1alpha1.GetBreakingChangePolicyResponse
	20, // 42: buf.alpha.registry.v1alpha1.AdminService.UpdateBreakingChangePolicy:output_type -> buf.alpha.registry.v1alpha1.UpdateBreakingChangePolicyResponse
	22, // 43: buf.alpha.registry.v1alpha1.AdminService.GetUniquenessPolicy:output_type -> buf.alpha.registry.v1alpha1.GetUniquenessPolicyResponse
	24, // 44: buf.alpha.registry.v1alpha1.AdminService.UpdateUniquenessPolicy:output_type -> buf.alpha.registry.v1alpha1.UpdateUniquenessPolicyResponse
	26, // 45: buf.alpha.registry.v1alpha1.AdminService.ListServerUniquenessCollisions:output_type -> buf.alpha.registry.v1alpha1.ListServerUniquenessCollisionsResponse
	28, // 46: buf.alpha.registry.v1alpha1.AdminService.RunServerUniquenessBackfillTask:output_type -> buf.alpha.registry.v1alpha1.RunServerUniquenessBackfillTaskResponse
	30, // 47: buf.alpha.registry.v1alpha1.AdminService.GetReviewFlowGracePeriodPolicy:output_type -> buf.alpha.registry.v1alpha1.GetReviewFlowGracePeriodPolicyResponse
	32, // 48: buf.alpha.registry.v1alpha1.AdminService.UpdateReviewFlowGracePeriodPolicy:output_type -> buf.alpha.registry.v1alpha1.UpdateReviewFlowGracePeriodPolicyResponse
	34, // 49: buf.alpha.registry.v1alpha1.AdminService.GetClusterUsage:output_type -> buf.alpha.registry.v1alpha1.GetClusterUsageResponse
	36, // 50: buf.alpha.registry.v1alpha1.AdminService.ListRepositoriesUsage:output_type -> buf.alpha.registry.v1alpha1.ListRepositoriesUsageResponse
...
func file_buf_alpha_registry_v1alpha1_admin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListRepositoriesUsageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListRepositoriesUsageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_buf_alpha_registry_v1alpha1_admin_proto_msgTypes[31].OneofWrappers = []interface{}{
		(*GetClusterUsageRequest_OwnerId)(nil),
		(*GetClusterUsageRequest_RepositoryId)(nil),
	}
	type x struct{}
