...
type GracePeriodPolicy struct {
	...
	GracePeriodSeconds uint64 `protobuf:"varint,1,opt,name=grace_period_seconds,json=gracePeriodSeconds,proto3" json:"grace_period_seconds,omitempty"`
}
...
func (x *GracePeriodPolicy) GetGracePeriodSeconds() uint64 {
	if x != nil {
...
var file_buf_alpha_registry_v1alpha1_admin_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x67, 0x72, 0x61, 0x63, 0x65, 0x50, 0x65, 0x72, 0x69,
