...
type CountRepositoryTagsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The ID of the repository whose tags should be counted.
	RepositoryId string `protobuf:"bytes,1,opt,name=repository_id,json=repositoryId,proto3" json:"repository_id,omitempty"`
}

func (x *CountRepositoryTagsRequest) Reset() {
	*x = CountRepositoryTagsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CountRepositoryTagsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CountRepositoryTagsRequest) ProtoMessage() {}

func (x *CountRepositoryTagsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_repository_tag_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CountRepositoryTagsRequest.ProtoReflect.Descriptor instead.
func (*CountRepositoryTagsRequest) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_repository_tag_proto_rawDescGZIP(), []int{5}
}

func (x *CountRepositoryTagsRequest) GetRepositoryId() string {
	if x != nil {
		return x.RepositoryId
	}
	return ""
...
type CountRepositoryTagsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CountRepositoryTagsResponse) Reset() {
	*x = CountRepositoryTagsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CountRepositoryTagsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CountRepositoryTagsResponse) ProtoMessage() {}

func (x *CountRepositoryTagsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_registry_v1alpha1_repository_tag_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CountRepositoryTagsResponse.ProtoReflect.Descriptor instead.
func (*CountRepositoryTagsResponse) Descriptor() ([]byte, []int) {
	return file_buf_alpha_registry_v1alpha1_repository_tag_proto_rawDescGZIP(), []int{6}
}

func (x *CountRepositoryTagsResponse) GetTotalCount() uint32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
var file_buf_alpha_registry_v1alpha1_repository_tag_proto_rawDesc = []byte{
	...
	,
	...
	0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x38, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x61,
	...
	0x73, 0x65, 0x12, 0x85, 0x01, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x73,
	0x69, 0x74, 0x6f, 0x72, 0x79, 0x54, 0x61, 0x67, 0x73, 0x12, 0x36, 0x2e, 0x62, 0x75, 0x66, 0x2e,
	...
	,
...
var file_buf_alpha_registry_v1alpha1_repository_tag_proto_goTypes = []interface{}{
	...
	(*CountRepositoryTagsRequest)(nil),  // 5: buf.alpha.registry.v1alpha1.CountRepositoryTagsRequest
	(*CountRepositoryTagsResponse)(nil), // 6: buf.alpha.registry.v1alpha1.CountRepositoryTagsResponse
...
var file_buf_alpha_registry_v1alpha1_repository_tag_proto_depIdxs = []int32{
	...
	5, // 5: buf.alpha.registry.v1alpha1.RepositoryTagService.CountRepositoryTags:input_type -> buf.alpha.registry.v1alpha1.CountRepositoryTagsRequest
	2, // 6: buf.alpha.registry.v1alpha1.RepositoryTagService.CreateRepositoryTag:output_type -> buf.alpha.registry.v1alpha1.CreateRepositoryTagResponse
	4, // 7: buf.alpha.registry.v1alpha1.RepositoryTagService.ListRepositoryTags:output_type -> buf.alpha.registry.v1alpha1.ListRepositoryTagsResponse
	6, // 8: buf.alpha.registry.v1alpha1.RepositoryTagService.CountRepositoryTags:output_type -> buf.alpha.registry.v1alpha1.CountRepositoryTagsResponse
...
func file_buf_alpha_registry_v1alpha1_repository_tag_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_alpha_registry_v1alpha1_repository_tag_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CountRepositoryTagsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_buf_alpha_registry_v1alpha1_repository_tag_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CountRepositoryTagsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
