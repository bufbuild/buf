...
func (x *PushRequest) MarshalWithDescriptorInfo() ([]byte, error) {
	...
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.registry.v1alpha1.PushRequest",
			},
		},
	)
	if err != nil {
...
func (x *PushResponse) MarshalWithDescriptorInfo() ([]byte, error) {
	bytes, err := proto.Marshal(x)
	if err != nil {
		return nil, err
	}
	descriptorInfoBytes, err := proto.Marshal(
		&v1alpha1.Reflector{
			DescriptorInfo: &v1alpha1.DescriptorInfo{
				...
				TypeName: "buf.alpha.registry.v1alpha1.PushResponse",
			},
		},
	)
	if err != nil {
