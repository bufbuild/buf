...
func (x BufAlphaRegistryV1Alpha1UserState) Enum() *BufAlphaRegistryV1Alpha1UserState {
	p := new(BufAlphaRegistryV1Alpha1UserState)
	*p = x
	return p
}
...
func (BufAlphaRegistryV1Alpha1UserState) Descriptor() protoreflect.EnumDescriptor {
	return file_buf_alpha_audit_v1alpha1_user_proto_enumTypes[0].Descriptor()
}

func (BufAlphaRegistryV1Alpha1UserState) Type() protoreflect.EnumType {
	return &file_buf_alpha_audit_v1alpha1_user_proto_enumTypes[0]
}
...
func (BufAlphaRegistryV1Alpha1UserState) EnumDescriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_user_proto_rawDescGZIP(), []int{0}
}

var File_buf_alpha_audit_v1alpha1_user_proto protoreflect.FileDescriptor

var file_buf_alpha_audit_v1alpha1_user_proto_rawDesc = []byte{
	...
	0xc9, 0x01, 0x0a, 0x21, 0x42, 0x75, 0x66, 0x41, 0x6c, 0x70, 0x68, 0x61, 0x52, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x72, 0x79, 0x56, 0x31, 0x41, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x55, 0x73, 0x65, 0x72,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x37, 0x0a, 0x33, 0x42, 0x55, 0x46, 0x5f, 0x41, 0x4c, 0x50,
	0x48, 0x41, 0x5f, 0x52, 0x45, 0x47, 0x49, 0x53, 0x54, 0x52, 0x59, 0x5f, 0x56, 0x31, 0x5f, 0x41,
	0x4c, 0x50, 0x48, 0x41, 0x31, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45,
	...
	0x10, 0x01, 0x12, 0x37, 0x0a, 0x33, 0x42, 0x55, 0x46, 0x5f, 0x41, 0x4c, 0x50, 0x48, 0x41, 0x5f,
	0x52, 0x45, 0x47, 0x49, 0x53, 0x54, 0x52, 0x59, 0x5f, 0x56, 0x31, 0x5f, 0x41, 0x4c, 0x50, 0x48,
	0x41, 0x31, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x44, 0x45,
	0x41, 0x43, 0x54, 0x49, 0x56, 0x41, 0x54, 0x45, 0x44, 0x10, 0x02, 0x42, 0x81, 0x02, 0x0a, 0x1c,
	0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x61, 0x75,
	0x64, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x09, 0x55, 0x73,
	0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x53, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var (
	file_buf_alpha_audit_v1alpha1_user_proto_rawDescOnce sync.Once
	file_buf_alpha_audit_v1alpha1_user_proto_rawDescData = file_buf_alpha_audit_v1alpha1_user_proto_rawDesc
)

func file_buf_alpha_audit_v1alpha1_user_proto_rawDescGZIP() []byte {
	file_buf_alpha_audit_v1alpha1_user_proto_rawDescOnce.Do(func() {
		file_buf_alpha_audit_v1alpha1_user_proto_rawDescData = protoimpl.X.CompressGZIP(file_buf_alpha_audit_v1alpha1_user_proto_rawDescData)
	})
	return file_buf_alpha_audit_v1alpha1_user_proto_rawDescData
}

var file_buf_alpha_audit_v1alpha1_user_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_buf_alpha_audit_v1alpha1_user_proto_goTypes = []interface{}{
	(BufAlphaRegistryV1Alpha1UserState)(0), // 0: buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1UserState
}
var file_buf_alpha_audit_v1alpha1_user_proto_depIdxs = []int32{
...
func init() { file_buf_alpha_audit_v1alpha1_user_proto_init() }
func file_buf_alpha_audit_v1alpha1_user_proto_init() {
	if File_buf_alpha_audit_v1alpha1_user_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_buf_alpha_audit_v1alpha1_user_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_buf_alpha_audit_v1alpha1_user_proto_goTypes,
		DependencyIndexes: file_buf_alpha_audit_v1alpha1_user_proto_depIdxs,
		EnumInfos:         file_buf_alpha_audit_v1alpha1_user_proto_enumTypes,
	}.Build()
	File_buf_alpha_audit_v1alpha1_user_proto = out.File
	file_buf_alpha_audit_v1alpha1_user_proto_rawDesc = nil
	file_buf_alpha_audit_v1alpha1_user_proto_goTypes = nil
	file_buf_alpha_audit_v1alpha1_user_proto_depIdxs = nil
}
