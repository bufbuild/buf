...
type PayloadOrganizationIDPGroupAdded struct {
	...
	OrganizationName string `protobuf:"bytes,2,opt,name=organization_name,json=organizationName,proto3" json:"organization_name,omitempty"`
	// group_id is the ID of the IDP group added to the organization.
	GroupId string `protobuf:"bytes,3,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// group_name is the name of the IDP group added to the organization.
...
func (x *PayloadOrganizationIDPGroupAdded) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *PayloadOrganizationIDPGroupAdded) GetGroupName() string {
	if x != nil {
		return x.GroupName
	}
	return ""
...
type PayloadOrganizationIDPGroupRemoved struct {
	...
	OrganizationName string `protobuf:"bytes,2,opt,name=organization_name,json=organizationName,proto3" json:"organization_name,omitempty"`
	// group_id is the ID of the IDP group removed from the organization.
	GroupId string `protobuf:"bytes,3,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// group_name is the name of the IDP group removed from the organization.
	GroupName string `protobuf:"bytes,4,opt,name=group_name,json=groupName,proto3" json:"group_name,omitempty"`
}
...
func (x *PayloadOrganizationIDPGroupRemoved) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *PayloadOrganizationIDPGroupRemoved) GetGroupName() string {
	if x != nil {
		return x.GroupName
	}
	return ""
...
var file_buf_alpha_audit_v1alpha1_event_proto_rawDesc = []byte{
	...
	0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xb2, 0x01, 0x0a, 0x20, 0x50, 0x61, 0x79, 0x6c, 0x6f,
	...
	0x52, 0x09, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xb4, 0x01, 0x0a, 0x22,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75,
	...
	0x72, 0x79, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x56, 0x69, 0x73, 0x69,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x52, 0x0a, 0x76, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69,
	0x74, 0x79, 0x22, 0xda, 0x01, 0x0a, 0x1d, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65,
	...
	0x4f, 0x75, 0x74, 0x22, 0x57, 0x0a, 0x1b, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x43, 0x75,
	...
	0x09, 0x52, 0x09, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x2a, 0x53, 0x0a, 0x09,
	...
	0x02, 0x2a, 0xe3, 0x02, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79,
	...
	0x4c, 0x55, 0x47, 0x49, 0x4e, 0x10, 0x08, 0x2a, 0x88, 0x07, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e,
	...
	0x4f, 0x47, 0x47, 0x45, 0x44, 0x5f, 0x4f, 0x55, 0x54, 0x10, 0x13, 0x12, 0x25, 0x0a, 0x21, 0x45,
	...
	0x10, 0x14, 0x42, 0x82, 0x02, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x2e, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
