...
const (
	...
	EventType_EVENT_TYPE_ORGANIZATION_METADATA_UPDATED            EventType = 50
	EventType_EVENT_TYPE_ORGANIZATION_VERIFICATION_STATUS_CHANGED EventType = 51
	...
	EventType_EVENT_TYPE_REPOSITORY_METADATA_UPDATED              EventType = 52
	...
	EventType_EVENT_TYPE_USER_METADATA_UPDATED                    EventType = 53
	EventType_EVENT_TYPE_USER_VERIFICATION_STATUS_CHANGED         EventType = 54
...
var (
	EventType_name = map[int32]string{
		...
		50: "EVENT_TYPE_ORGANIZATION_METADATA_UPDATED",
		51: "EVENT_TYPE_ORGANIZATION_VERIFICATION_STATUS_CHANGED",
		...
		52: "EVENT_TYPE_REPOSITORY_METADATA_UPDATED",
		...
		53: "EVENT_TYPE_USER_METADATA_UPDATED",
		54: "EVENT_TYPE_USER_VERIFICATION_STATUS_CHANGED",
	...
	EventType_value = map[string]int32{
		...
		"EVENT_TYPE_ORGANIZATION_METADATA_UPDATED":            50,
		"EVENT_TYPE_ORGANIZATION_VERIFICATION_STATUS_CHANGED": 51,
		...
		"EVENT_TYPE_REPOSITORY_METADATA_UPDATED":              52,
		...
		"EVENT_TYPE_USER_METADATA_UPDATED":                    53,
		"EVENT_TYPE_USER_VERIFICATION_STATUS_CHANGED":         54,
...
type Event struct {
	...
	//	*Event_OrganizationMetadataUpdated
	//	*Event_OrganizationVerificationStatusChanged
	...
	//	*Event_RepositoryMetadataUpdated
	//	*Event_PluginCreated
	//	*Event_PluginDeleted
	...
	//	*Event_UserLoggedIn
	//	*Event_UserLoggedOut
	//	*Event_UserMetadataUpdated
	//	*Event_UserVerificationStatusChanged
...
func (x *Event) GetOrganizationMetadataUpdated() *PayloadOrganizationMetadataUpdated {
	if x, ok := x.GetPayload().(*Event_OrganizationMetadataUpdated); ok {
		return x.OrganizationMetadataUpdated
	}
	return nil
}

func (x *Event) GetOrganizationVerificationStatusChanged() *PayloadOrganizationVerificationStatusChanged {
	if x, ok := x.GetPayload().(*Event_OrganizationVerificationStatusChanged); ok {
		return x.OrganizationVerificationStatusChanged
	}
	return nil
}
...
func (x *Event) GetRepositoryDeprecated() *PayloadRepositoryDeprecated {
	if x, ok := x.GetPayload().(*Event_RepositoryDeprecated); ok {
...
func (x *Event) GetRepositoryUndeprecated() *PayloadRepositoryUndeprecated {
	if x, ok := x.GetPayload().(*Event_RepositoryUndeprecated); ok {
...
func (x *Event) GetRepositoryMetadataUpdated() *PayloadRepositoryMetadataUpdated {
	if x, ok := x.GetPayload().(*Event_RepositoryMetadataUpdated); ok {
		return x.RepositoryMetadataUpdated
	}
	return nil
}
...
func (x *Event) GetPluginCommitPushed() *PayloadPluginCommitPushed {
	if x, ok := x.GetPayload().(*Event_PluginCommitPushed); ok {
...
func (x *Event) GetUserMetadataUpdated() *PayloadUserMetadataUpdated {
	if x, ok := x.GetPayload().(*Event_UserMetadataUpdated); ok {
		return x.UserMetadataUpdated
	}
	return nil
}

func (x *Event) GetUserVerificationStatusChanged() *PayloadUserVerificationStatusChanged {
	if x, ok := x.GetPayload().(*Event_UserVerificationStatusChanged); ok {
		return x.UserVerificationStatusChanged
	}
	return nil
}
...
func (x *Event) GetPluginLabelCreated() *PayloadPluginLabelCreated {
	if x, ok := x.GetPayload().(*Event_PluginLabelCreated); ok {
...
func (x *Event) GetPluginLabelMoved() *PayloadPluginLabelMoved {
	if x, ok := x.GetPayload().(*Event_PluginLabelMoved); ok {
...
func (x *Event) GetPluginLabelArchived() *PayloadPluginLabelArchived {
	if x, ok := x.GetPayload().(*Event_PluginLabelArchived); ok {
...
func (x *Event) GetPluginLabelUnarchived() *PayloadPluginLabelUnarchived {
	if x, ok := x.GetPayload().(*Event_PluginLabelUnarchived); ok {
...
type Event_OrganizationMetadataUpdated struct {
	OrganizationMetadataUpdated *PayloadOrganizationMetadataUpdated `protobuf:"bytes,56,opt,name=organization_metadata_updated,json=organizationMetadataUpdated,proto3,oneof"`
}

type Event_OrganizationVerificationStatusChanged struct {
	OrganizationVerificationStatusChanged *PayloadOrganizationVerificationStatusChanged `protobuf:"bytes,57,opt,name=organization_verification_status_changed,json=organizationVerificationStatusChanged,proto3,oneof"`
}
...
type Event_RepositoryMetadataUpdated struct {
	RepositoryMetadataUpdated *PayloadRepositoryMetadataUpdated `protobuf:"bytes,58,opt,name=repository_metadata_updated,json=repositoryMetadataUpdated,proto3,oneof"`
}
...
type Event_UserMetadataUpdated struct {
	UserMetadataUpdated *PayloadUserMetadataUpdated `protobuf:"bytes,59,opt,name=user_metadata_updated,json=userMetadataUpdated,proto3,oneof"`
}

type Event_UserVerificationStatusChanged struct {
	UserVerificationStatusChanged *PayloadUserVerificationStatusChanged `protobuf:"bytes,60,opt,name=user_verification_status_changed,json=userVerificationStatusChanged,proto3,oneof"`
}
...
func (*Event_OrganizationMetadataUpdated) isEvent_Payload() {}

func (*Event_OrganizationVerificationStatusChanged) isEvent_Payload() {}
...
func (*Event_RepositoryMetadataUpdated) isEvent_Payload() {}
...
func (*Event_UserMetadataUpdated) isEvent_Payload() {}

func (*Event_UserVerificationStatusChanged) isEvent_Payload() {}
...
type PayloadOrganizationMetadataUpdated struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The description update that happened to the organization.
	DescriptionUpdate *PayloadOrganizationMetadataUpdated_DescriptionUpdate `protobuf:"bytes,1,opt,name=description_update,json=descriptionUpdate,proto3,oneof" json:"description_update,omitempty"`
	// The url update that happened to the organization.
	UrlUpdate *PayloadOrganizationMetadataUpdated_UrlUpdate `protobuf:"bytes,2,opt,name=url_update,json=urlUpdate,proto3,oneof" json:"url_update,omitempty"`
}

func (x *PayloadOrganizationMetadataUpdated) Reset() {
	*x = PayloadOrganizationMetadataUpdated{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadOrganizationMetadataUpdated) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadOrganizationMetadataUpdated) ProtoMessage() {}

func (x *PayloadOrganizationMetadataUpdated) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadOrganizationMetadataUpdated.ProtoReflect.Descriptor instead.
func (*PayloadOrganizationMetadataUpdated) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{6}
}

func (x *PayloadOrganizationMetadataUpdated) GetDescriptionUpdate() *PayloadOrganizationMetadataUpdated_DescriptionUpdate {
	if x != nil {
		return x.DescriptionUpdate
	}
	return nil
}

func (x *PayloadOrganizationMetadataUpdated) GetUrlUpdate() *PayloadOrganizationMetadataUpdated_UrlUpdate {
	if x != nil {
		return x.UrlUpdate
	}
	return nil
...
type PayloadOrganizationVerificationStatusChanged struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// old_verification_status is the organization verification status before the update.
	OldVerificationStatus string `protobuf:"bytes,1,opt,name=old_verification_status,json=oldVerificationStatus,proto3" json:"old_verification_status,omitempty"`
	// new_verification_status is the organization verification status after the update.
	NewVerificationStatus string `protobuf:"bytes,2,opt,name=new_verification_status,json=newVerificationStatus,proto3" json:"new_verification_status,omitempty"`
}

func (x *PayloadOrganizationVerificationStatusChanged) Reset() {
	*x = PayloadOrganizationVerificationStatusChanged{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadOrganizationVerificationStatusChanged) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadOrganizationVerificationStatusChanged) ProtoMessage() {}

func (x *PayloadOrganizationVerificationStatusChanged) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadOrganizationVerificationStatusChanged.ProtoReflect.Descriptor instead.
func (*PayloadOrganizationVerificationStatusChanged) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{7}
}

func (x *PayloadOrganizationVerificationStatusChanged) GetOldVerificationStatus() string {
	if x != nil {
		return x.OldVerificationStatus
	}
	return ""
}

func (x *PayloadOrganizationVerificationStatusChanged) GetNewVerificationStatus() string {
	if x != nil {
		return x.NewVerificationStatus
	}
	return ""
}
...
type PayloadRepositoryMetadataUpdated struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The description update that happened to the repository.
	DescriptionUpdate *PayloadRepositoryMetadataUpdated_DescriptionUpdate `protobuf:"bytes,1,opt,name=description_update,json=descriptionUpdate,proto3,oneof" json:"description_update,omitempty"`
	// The url update that happened to the repository.
	UrlUpdate *PayloadRepositoryMetadataUpdated_UrlUpdate `protobuf:"bytes,2,opt,name=url_update,json=urlUpdate,proto3,oneof" json:"url_update,omitempty"`
}

func (x *PayloadRepositoryMetadataUpdated) Reset() {
	*x = PayloadRepositoryMetadataUpdated{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadRepositoryMetadataUpdated) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadRepositoryMetadataUpdated) ProtoMessage() {}

func (x *PayloadRepositoryMetadataUpdated) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadRepositoryMetadataUpdated.ProtoReflect.Descriptor instead.
func (*PayloadRepositoryMetadataUpdated) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{24}
}

func (x *PayloadRepositoryMetadataUpdated) GetDescriptionUpdate() *PayloadRepositoryMetadataUpdated_DescriptionUpdate {
	if x != nil {
		return x.DescriptionUpdate
	}
	return nil
...
func (x *PayloadRepositoryMetadataUpdated) GetUrlUpdate() *PayloadRepositoryMetadataUpdated_UrlUpdate {
	if x != nil {
		return x.UrlUpdate
	}
	return nil
...
type PayloadUserMetadataUpdated struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The description update that happened to the user.
	DescriptionUpdate *PayloadUserMetadataUpdated_DescriptionUpdate `protobuf:"bytes,1,opt,name=description_update,json=descriptionUpdate,proto3,oneof" json:"description_update,omitempty"`
	// The url update that happened to the user.
	UrlUpdate *PayloadUserMetadataUpdated_UrlUpdate `protobuf:"bytes,2,opt,name=url_update,json=urlUpdate,proto3,oneof" json:"url_update,omitempty"`
}

func (x *PayloadUserMetadataUpdated) Reset() {
	*x = PayloadUserMetadataUpdated{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadUserMetadataUpdated) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadUserMetadataUpdated) ProtoMessage() {}

func (x *PayloadUserMetadataUpdated) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadUserMetadataUpdated.ProtoReflect.Descriptor instead.
func (*PayloadUserMetadataUpdated) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{34}
}

func (x *PayloadUserMetadataUpdated) GetDescriptionUpdate() *PayloadUserMetadataUpdated_DescriptionUpdate {
	if x != nil {
		return x.DescriptionUpdate
	}
	return nil
...
func (x *PayloadUserMetadataUpdated) GetUrlUpdate() *PayloadUserMetadataUpdated_UrlUpdate {
	if x != nil {
		return x.UrlUpdate
	}
	return nil
...
type PayloadUserVerificationStatusChanged struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// old_verification_status is the user verification status before the update.
	OldVerificationStatus string `protobuf:"bytes,1,opt,name=old_verification_status,json=oldVerificationStatus,proto3" json:"old_verification_status,omitempty"`
	// new_verification_status is the user verification status after the update.
	NewVerificationStatus string `protobuf:"bytes,2,opt,name=new_verification_status,json=newVerificationStatus,proto3" json:"new_verification_status,omitempty"`
}

func (x *PayloadUserVerificationStatusChanged) Reset() {
	*x = PayloadUserVerificationStatusChanged{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadUserVerificationStatusChanged) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadUserVerificationStatusChanged) ProtoMessage() {}

func (x *PayloadUserVerificationStatusChanged) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadUserVerificationStatusChanged.ProtoReflect.Descriptor instead.
func (*PayloadUserVerificationStatusChanged) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{35}
}

func (x *PayloadUserVerificationStatusChanged) GetOldVerificationStatus() string {
	if x != nil {
		return x.OldVerificationStatus
	}
	return ""
...
func (x *PayloadUserVerificationStatusChanged) GetNewVerificationStatus() string {
	if x != nil {
		return x.NewVerificationStatus
	}
	return ""
...
type PayloadOrganizationMetadataUpdated_DescriptionUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// old_description is the organization description before the update.
	OldDescription string `protobuf:"bytes,1,opt,name=old_description,json=oldDescription,proto3" json:"old_description,omitempty"`
	// new_description is the organization description after the update.
...
func (x *PayloadOrganizationMetadataUpdated_DescriptionUpdate) Reset() {
	*x = PayloadOrganizationMetadataUpdated_DescriptionUpdate{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadOrganizationMetadataUpdated_DescriptionUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadOrganizationMetadataUpdated_DescriptionUpdate) ProtoMessage() {}

func (x *PayloadOrganizationMetadataUpdated_DescriptionUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[58]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadOrganizationMetadataUpdated_DescriptionUpdate.ProtoReflect.Descriptor instead.
func (*PayloadOrganizationMetadataUpdated_DescriptionUpdate) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{6, 0}
}

func (x *PayloadOrganizationMetadataUpdated_DescriptionUpdate) GetOldDescription() string {
	if x != nil {
...
func (x *PayloadOrganizationMetadataUpdated_DescriptionUpdate) GetNewDescription() string {
	if x != nil {
...
type PayloadOrganizationMetadataUpdated_UrlUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// old_url is the organization url before the update.
	OldUrl string `protobuf:"bytes,3,opt,name=old_url,json=oldUrl,proto3" json:"old_url,omitempty"`
	// new_url is the organization url after the update.
	NewUrl string `protobuf:"bytes,4,opt,name=new_url,json=newUrl,proto3" json:"new_url,omitempty"`
}

func (x *PayloadOrganizationMetadataUpdated_UrlUpdate) Reset() {
	*x = PayloadOrganizationMetadataUpdated_UrlUpdate{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadOrganizationMetadataUpdated_UrlUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadOrganizationMetadataUpdated_UrlUpdate) ProtoMessage() {}

func (x *PayloadOrganizationMetadataUpdated_UrlUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadOrganizationMetadataUpdated_UrlUpdate.ProtoReflect.Descriptor instead.
func (*PayloadOrganizationMetadataUpdated_UrlUpdate) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{6, 1}
}

func (x *PayloadOrganizationMetadataUpdated_UrlUpdate) GetOldUrl() string {
	if x != nil {
		return x.OldUrl
	}
	return ""
...
func (x *PayloadOrganizationMetadataUpdated_UrlUpdate) GetNewUrl() string {
	if x != nil {
		return x.NewUrl
	}
	return ""
...
type PayloadRepositoryMetadataUpdated_DescriptionUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// old_description is the repository description before the update.
	OldDescription string `protobuf:"bytes,1,opt,name=old_description,json=oldDescription,proto3" json:"old_description,omitempty"`
	// new_description is the repository description after the update.
	NewDescription string `protobuf:"bytes,2,opt,name=new_description,json=newDescription,proto3" json:"new_description,omitempty"`
}

func (x *PayloadRepositoryMetadataUpdated_DescriptionUpdate) Reset() {
	*x = PayloadRepositoryMetadataUpdated_DescriptionUpdate{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadRepositoryMetadataUpdated_DescriptionUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadRepositoryMetadataUpdated_DescriptionUpdate) ProtoMessage() {}

func (x *PayloadRepositoryMetadataUpdated_DescriptionUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[60]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadRepositoryMetadataUpdated_DescriptionUpdate.ProtoReflect.Descriptor instead.
func (*PayloadRepositoryMetadataUpdated_DescriptionUpdate) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{24, 0}
}

func (x *PayloadRepositoryMetadataUpdated_DescriptionUpdate) GetOldDescription() string {
	if x != nil {
		return x.OldDescription
	}
	return ""
...
func (x *PayloadRepositoryMetadataUpdated_DescriptionUpdate) GetNewDescription() string {
	if x != nil {
		return x.NewDescription
	}
	return ""
...
type PayloadRepositoryMetadataUpdated_UrlUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// old_url is the repository url before the update.
	OldUrl string `protobuf:"bytes,3,opt,name=old_url,json=oldUrl,proto3" json:"old_url,omitempty"`
	// new_url is the repository url after the update.
	NewUrl string `protobuf:"bytes,4,opt,name=new_url,json=newUrl,proto3" json:"new_url,omitempty"`
}

func (x *PayloadRepositoryMetadataUpdated_UrlUpdate) Reset() {
	*x = PayloadRepositoryMetadataUpdated_UrlUpdate{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadRepositoryMetadataUpdated_UrlUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadRepositoryMetadataUpdated_UrlUpdate) ProtoMessage() {}

func (x *PayloadRepositoryMetadataUpdated_UrlUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[61]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadRepositoryMetadataUpdated_UrlUpdate.ProtoReflect.Descriptor instead.
func (*PayloadRepositoryMetadataUpdated_UrlUpdate) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{24, 1}
}

func (x *PayloadRepositoryMetadataUpdated_UrlUpdate) GetOldUrl() string {
	if x != nil {
		return x.OldUrl
	}
	return ""
...
func (x *PayloadRepositoryMetadataUpdated_UrlUpdate) GetNewUrl() string {
	if x != nil {
		return x.NewUrl
	}
	return ""
...
type PayloadUserMetadataUpdated_DescriptionUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// old_description is the user description before the update.
	OldDescription string `protobuf:"bytes,1,opt,name=old_description,json=oldDescription,proto3" json:"old_description,omitempty"`
	// new_description is the user description after the update.
	NewDescription string `protobuf:"bytes,2,opt,name=new_description,json=newDescription,proto3" json:"new_description,omitempty"`
}

func (x *PayloadUserMetadataUpdated_DescriptionUpdate) Reset() {
	*x = PayloadUserMetadataUpdated_DescriptionUpdate{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadUserMetadataUpdated_DescriptionUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadUserMetadataUpdated_DescriptionUpdate) ProtoMessage() {}

func (x *PayloadUserMetadataUpdated_DescriptionUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[62]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadUserMetadataUpdated_DescriptionUpdate.ProtoReflect.Descriptor instead.
func (*PayloadUserMetadataUpdated_DescriptionUpdate) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{34, 0}
}

func (x *PayloadUserMetadataUpdated_DescriptionUpdate) GetOldDescription() string {
	if x != nil {
		return x.OldDescription
	}
	return ""
...
func (x *PayloadUserMetadataUpdated_DescriptionUpdate) GetNewDescription() string {
	if x != nil {
		return x.NewDescription
	}
	return ""
...
type PayloadUserMetadataUpdated_UrlUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// old_url is the user url before the update.
	OldUrl string `protobuf:"bytes,3,opt,name=old_url,json=oldUrl,proto3" json:"old_url,omitempty"`
	// new_url is the user url after the update.
	NewUrl string `protobuf:"bytes,4,opt,name=new_url,json=newUrl,proto3" json:"new_url,omitempty"`
}

func (x *PayloadUserMetadataUpdated_UrlUpdate) Reset() {
	*x = PayloadUserMetadataUpdated_UrlUpdate{}
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PayloadUserMetadataUpdated_UrlUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadUserMetadataUpdated_UrlUpdate) ProtoMessage() {}

func (x *PayloadUserMetadataUpdated_UrlUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadUserMetadataUpdated_UrlUpdate.ProtoReflect.Descriptor instead.
func (*PayloadUserMetadataUpdated_UrlUpdate) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{34, 1}
}

func (x *PayloadUserMetadataUpdated_UrlUpdate) GetOldUrl() string {
	if x != nil {
		return x.OldUrl
	}
	return ""
...
func (x *PayloadUserMetadataUpdated_UrlUpdate) GetNewUrl() string {
	if x != nil {
		return x.NewUrl
	}
	return ""
...
var file_buf_alpha_audit_v1alpha1_event_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x72, 0x61, 0x63, 0x65, 0x49, 0x64, 0x22, 0xc0, 0x34,
	...
	0x6e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x12, 0x82, 0x01, 0x0a, 0x1d, 0x6f, 0x72, 0x67,
	0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0
	0x50, 0x44, 0x41, 0x54, 0x45, 0x44, 0x10, 0x32, 0x12, 0x37, 0x0a, 0x33, 0x45, 0x56, 0x45, 0x4e,
	...
	0x33, 0x12, 0x28, 0x0a, 0x24, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f,
	...
	0x45, 0x41, 0x54, 0x45, 0x44, 0x10, 0x06, 0x12, 0x24, 0x0a, 0x20, 0x45, 0x56, 0x45, 0x4e, 0x54,
	0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x52, 0x45, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x4f, 0x52, 0x59,
	0x5f, 0x44, 0x45, 0x50, 0x52, 0x45, 0x43, 0x41, 0x54, 0x45, 0x44, 0x10, 0x30, 0x12, 0x26, 0x0a,
	0x22, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x52, 0x45, 0x50, 0x4f,
	0x53, 0x49, 0x54, 0x4f, 0x52, 0x59, 0x5f, 0x55, 0x4e, 0x44, 0x45, 0x50, 0x52, 0x45, 0x43, 0x41,
	0x54, 0x45, 0x44, 0x10, 0x31, 0x12, 0x21, 0x0a, 0x1d, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54,
	...
	,
	...
	0x12, 0x28, 0x0a, 0x24, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x52,
	0x45, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x4f, 0x52, 0x59, 0x5f, 0x4c, 0x41, 0x42, 0x45, 0x4c, 0x5f,
	0x41, 0x52, 0x43, 0x48, 0x49, 0x56, 0x45, 0x44, 0x10, 0x26, 0x12, 0x2a, 0x0a, 0x26, 0x45, 0x56,
	0x45, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x52, 0x45, 0x50, 0x4f, 0x53, 0x49, 0x54,
	0x4f, 0x52, 0x59, 0x5f, 0x4c, 0x41, 0x42, 0x45, 0x4c, 0x5f, 0x55, 0x4e, 0x41, 0x52, 0x43, 0x48,
	0x49, 0x56, 0x45, 0x44, 0x10, 0x27, 0x12, 0x34, 0x0a, 0x30, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f,
	...
	,
	...
	0x5f, 0x4e, 0x45, 0x57, 0x5f, 0x49, 0x44, 0x50, 0x10, 0x25, 0x12, 0x32, 0x0a, 0x2e, 0x45, 0x56,
	...
	,
...
var file_buf_alpha_audit_v1alpha1_event_proto_goTypes = []any{
	...
	(*PayloadOrganizationMetadataUpdated)(nil), // 9: buf.alpha.audit.v1alpha1.PayloadOrganizationMetadataUpdated
	(*PayloadOrganizationVerificationStatusChanged)(nil),         // 10: buf.alpha.audit.v1alpha1.PayloadOrganizationVerificationStatusChanged
	(*PayloadOrganizationMemberAdded)(nil),                       // 11: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberAdded
	(*PayloadOrganizationMemberRoleChanged)(nil),                 // 12: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged
	...
	(*PayloadRepositoryMetadataUpdated)(nil),                     // 27: buf.alpha.audit.v1alpha1.PayloadRepositoryMetadataUpdated
	(*PayloadPluginCreated)(nil),                                 // 28: buf.alpha.audit.v1alpha1.PayloadPluginCreated
	(*PayloadPluginDeleted)(nil),                                 // 29: buf.alpha.audit.v1alpha1.PayloadPluginDeleted
	(*PayloadPluginCommitPushed)(nil),                            // 30: buf.alpha.audit.v1alpha1.PayloadPluginCommitPushed
	(*PayloadUserCreated)(nil),                                   // 31: buf.alpha.audit.v1alpha1.PayloadUserCreated
	(*PayloadUserReactivated)(nil),                               // 32: buf.alpha.audit.v1alpha1.PayloadUserReactivated
	(*PayloadUserDeactivated)(nil),                               // 33: buf.alpha.audit.v1alpha1.PayloadUserDeactivated
	(*PayloadUserDeleted)(nil),                                   // 34: buf.alpha.audit.v1alpha1.PayloadUserDeleted
	(*PayloadUserLoggedIn)(nil),                                  // 35: buf.alpha.audit.v1alpha1.PayloadUserLoggedIn
	(*PayloadUserLoggedOut)(nil),                                 // 36: buf.alpha.audit.v1alpha1.PayloadUserLoggedOut
	(*PayloadUserMetadataUpdated)(nil),                           // 37: buf.alpha.audit.v1alpha1.PayloadUserMetadataUpdated
	(*PayloadUserVerificationStatusChanged)(nil),                 // 38: buf.alpha.audit.v1alpha1.PayloadUserVerificationStatusChanged
	(*PayloadUserAutoMergedFromNewIdP)(nil),                      // 39: buf.alpha.audit.v1alpha1.PayloadUserAutoMergedFromNewIdP
	(*PayloadCuratedPluginCreated)(nil),                          // 40: buf.alpha.audit.v1alpha1.PayloadCuratedPluginCreated
	(*PayloadCuratedPluginDeleted)(nil),                          // 41: buf.alpha.audit.v1alpha1.PayloadCuratedPluginDeleted
	(*PayloadTokenCreated)(nil),                                  // 42: buf.alpha.audit.v1alpha1.PayloadTokenCreated
	(*PayloadTokenDeleted)(nil),                                  // 43: buf.alpha.audit.v1alpha1.PayloadTokenDeleted
	(*PayloadSCIMTokenCreated)(nil),                              // 44: buf.alpha.audit.v1alpha1.PayloadSCIMTokenCreated
	(*PayloadSCIMTokenDeleted)(nil),                              // 45: buf.alpha.audit.v1alpha1.PayloadSCIMTokenDeleted
	(*PayloadRepositoryCommitDeleted)(nil),                       // 46: buf.alpha.audit.v1alpha1.PayloadRepositoryCommitDeleted
	(*PayloadRepositoryLabelCreated)(nil),                        // 47: buf.alpha.audit.v1alpha1.PayloadRepositoryLabelCreated
	(*PayloadRepositoryLabelMoved)(nil),                          // 48: buf.alpha.audit.v1alpha1.PayloadRepositoryLabelMoved
	(*PayloadRepositoryLabelArchived)(nil),                       // 49: buf.alpha.audit.v1alpha1.PayloadRepositoryLabelArchived
	(*PayloadRepositoryLabelUnarchived)(nil),                     // 50: buf.alpha.audit.v1alpha1.PayloadRepositoryLabelUnarchived
	(*PayloadServerBreakingChangePolicyEnabled)(nil),             // 51: buf.alpha.audit.v1alpha1.PayloadServerBreakingChangePolicyEnabled
	(*PayloadServerBreakingChangePolicyDisabled)(nil),            // 52: buf.alpha.audit.v1alpha1.PayloadServerBreakingChangePolicyDisabled
	(*PayloadServerUniquenessPolicyEnabled)(nil),                 // 53: buf.alpha.audit.v1alpha1.PayloadServerUniquenessPolicyEnabled
	(*PayloadServerUniquenessPolicyDisabled)(nil),                // 54: buf.alpha.audit.v1alpha1.PayloadServerUniquenessPolicyDisabled
	(*PayloadDeviceAuthorizationGrantApproved)(nil),              // 55: buf.alpha.audit.v1alpha1.PayloadDeviceAuthorizationGrantApproved
	(*PayloadDeviceAuthorizationGrantDenied)(nil),                // 56: buf.alpha.audit.v1alpha1.PayloadDeviceAuthorizationGrantDenied
	(*PayloadPluginLabelCreated)(nil),                            // 57: buf.alpha.audit.v1alpha1.PayloadPluginLabelCreated
	(*PayloadPluginLabelMoved)(nil),                              // 58: buf.alpha.audit.v1alpha1.PayloadPluginLabelMoved
	(*PayloadPluginLabelArchived)(nil),                           // 59: buf.alpha.audit.v1alpha1.PayloadPluginLabelArchived
	(*PayloadPluginLabelUnarchived)(nil),                         // 60: buf.alpha.audit.v1alpha1.PayloadPluginLabelUnarchived
	(*PayloadOrganizationMetadataUpdated_DescriptionUpdate)(nil), // 61: buf.alpha.audit.v1alpha1.PayloadOrganizationMetadataUpdated.DescriptionUpdate
	(*PayloadOrganizationMetadataUpdated_UrlUpdate)(nil),         // 62: buf.alpha.audit.v1alpha1.PayloadOrganizationMetadataUpdated.UrlUpdate
	(*PayloadRepositoryMetadataUpdated_DescriptionUpdate)(nil),   // 63: buf.alpha.audit.v1alpha1.PayloadRepositoryMetadataUpdated.DescriptionUpdate
	(*PayloadRepositoryMetadataUpdated_UrlUpdate)(nil),           // 64: buf.alpha.audit.v1alpha1.PayloadRepositoryMetadataUpdated.UrlUpdate
	(*PayloadUserMetadataUpdated_DescriptionUpdate)(nil),         // 65: buf.alpha.audit.v1alpha1.PayloadUserMetadataUpdated.DescriptionUpdate
	(*PayloadUserMetadataUpdated_UrlUpdate)(nil),                 // 66: buf.alpha.audit.v1alpha1.PayloadUserMetadataUpdated.UrlUpdate
...
var file_buf_alpha_audit_v1alpha1_event_proto_depIdxs = []int32{
	...
	9,  // 9: buf.alpha.audit.v1alpha1.Event.organization_metadata_updated:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationMetadataUpdated
	10, // 10: buf.alpha.audit.v1alpha1.Event.organization_verification_status_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationVerificationStatusChanged
	11, // 11: buf.alpha.audit.v1alpha1.Event.organization_member_added:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationMemberAdded
	12, // 12: buf.alpha.audit.v1alpha1.Event.organization_member_role_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged
	13, // 13: buf.alpha.audit.v1alpha1.Event.organization_member_removed:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRemoved
	16, // 14: buf.alpha.audit.v1alpha1.Event.repository_created:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryCreated
	18, // 15: buf.alpha.audit.v1alpha1.Event.repository_deprecated:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryDeprecated
	19, // 16: buf.alpha.audit.v1alpha1.Event.repository_undeprecated:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryUndeprecated
	17, // 17: buf.alpha.audit.v1alpha1.Event.repository_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryDeleted
	20, // 18: buf.alpha.audit.v1alpha1.Event.repository_commit_pushed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryCommitPushed
	21, // 19: buf.alpha.audit.v1alpha1.Event.repository_contributor_added:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryContributorAdded
	22, // 20: buf.alpha.audit.v1alpha1.Event.repository_contributor_role_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRoleChanged
	23, // 21: buf.alpha.audit.v1alpha1.Event.repository_contributor_removed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRemoved
	24, // 22: buf.alpha.audit.v1alpha1.Event.repository_visibility_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryVisibilityChanged
	25, // 23: buf.alpha.audit.v1alpha1.Event.repository_default_label_name_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryDefaultLabelNameChanged
	27, // 24: buf.alpha.audit.v1alpha1.Event.repository_metadata_updated:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryMetadataUpdated
	28, // 25: buf.alpha.audit.v1alpha1.Event.plugin_created:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginCreated
	29, // 26: buf.alpha.audit.v1alpha1.Event.plugin_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginDeleted
	30, // 27: buf.alpha.audit.v1alpha1.Event.plugin_commit_pushed:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginCommitPushed
	31, // 28: buf.alpha.audit.v1alpha1.Event.user_created:type_name -> buf.alpha.audit.v1alpha1.PayloadUserCreated
	33, // 29: buf.alpha.audit.v1alpha1.Event.user_deactivated:type_name -> buf.alpha.audit.v1alpha1.PayloadUserDeactivated
	34, // 30: buf.alpha.audit.v1alpha1.Event.user_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadUserDeleted
	35, // 31: buf.alpha.audit.v1alpha1.Event.user_logged_in:type_name -> buf.alpha.audit.v1alpha1.PayloadUserLoggedIn
	36, // 32: buf.alpha.audit.v1alpha1.Event.user_logged_out:type_name -> buf.alpha.audit.v1alpha1.PayloadUserLoggedOut
	37, // 33: buf.alpha.audit.v1alpha1.Event.user_metadata_updated:type_name -> buf.alpha.audit.v1alpha1.PayloadUserMetadataUpdated
	38, // 34: buf.alpha.audit.v1alpha1.Event.user_verification_status_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadUserVerificationStatusChanged
	40, // 35: buf.alpha.audit.v1alpha1.Event.curated_plugin_created:type_name -> buf.alpha.audit.v1alpha1.PayloadCuratedPluginCreated
	14, // 36: buf.alpha.audit.v1alpha1.Event.idp_group_added:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationIDPGroupAdded
	15, // 37: buf.alpha.audit.v1alpha1.Event.idp_group_removed:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationIDPGroupRemoved
	42, // 38: buf.alpha.audit.v1alpha1.Event.token_created:type_name -> buf.alpha.audit.v1alpha1.PayloadTokenCreated
	43, // 39: buf.alpha.audit.v1alpha1.Event.token_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadTokenDeleted
	32, // 40: buf.alpha.audit.v1alpha1.Event.user_reactivated:type_name -> buf.alpha.audit.v1alpha1.PayloadUserReactivated
	44, // 41: buf.alpha.audit.v1alpha1.Event.scim_token_created:type_name -> buf.alpha.audit.v1alpha1.PayloadSCIMTokenCreated
	45, // 42: buf.alpha.audit.v1alpha1.Event.scim_token_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadSCIMTokenDeleted
	46, // 43: buf.alpha.audit.v1alpha1.Event.repository_commit_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryCommitDeleted
	47, // 44: buf.alpha.audit.v1alpha1.Event.repository_label_created:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryLabelCreated
	48, // 45: buf.alpha.audit.v1alpha1.Event.repository_label_moved:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryLabelMoved
	49, // 46: buf.alpha.audit.v1alpha1.Event.repository_label_archived:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryLabelArchived
	50, // 47: buf.alpha.audit.v1alpha1.Event.repository_label_unarchived:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryLabelUnarchived
	41, // 48: buf.alpha.audit.v1alpha1.Event.curated_plugin_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadCuratedPluginDeleted
	51, // 49: buf.alpha.audit.v1alpha1.Event.payload_server_breaking_change_policy_enabled:type_name -> buf.alpha.audit.v1alpha1.PayloadServerBreakingChangePolicyEnabled
	52, // 50: buf.alpha.audit.v1alpha1.Event.payload_server_breaking_change_policy_disabled:type_name -> buf.alpha.audit.v1alpha1.PayloadServerBreakingChangePolicyDisabled
	26, // 51: buf.alpha.audit.v1alpha1.Event.repository_default_branch_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryDefaultBranchChanged
	53, // 52: buf.alpha.audit.v1alpha1.Event.payload_server_uniqueness_policy_enabled:type_name -> buf.alpha.audit.v1alpha1.PayloadServerUniquenessPolicyEnabled
	54, // 53: buf.alpha.audit.v1alpha1.Event.payload_server_uniqueness_policy_disabled:type_name -> buf.alpha.audit.v1alpha1.PayloadServerUniquenessPolicyDisabled
	39, // 54: buf.alpha.audit.v1alpha1.Event.user_auto_merged_from_new_idp:type_name -> buf.alpha.audit.v1alpha1.PayloadUserAutoMergedFromNewIdP
	55, // 55: buf.alpha.audit.v1alpha1.Event.device_authorization_grant_approved:type_name -> buf.alpha.audit.v1alpha1.PayloadDeviceAuthorizationGrantApproved
	56, // 56: buf.alpha.audit.v1alpha1.Event.device_authorization_grant_denied:type_name -> buf.alpha.audit.v1alpha1.PayloadDeviceAuthorizationGrantDenied
	57, // 57: buf.alpha.audit.v1alpha1.Event.plugin_label_created:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginLabelCreated
	58, // 58: buf.alpha.audit.v1alpha1.Event.plugin_label_moved:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginLabelMoved
	59, // 59: buf.alpha.audit.v1alpha1.Event.plugin_label_archived:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginLabelArchived
	60, // 60: buf.alpha.audit.v1alpha1.Event.plugin_label_unarchived:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginLabelUnarchived
	61, // 61: buf.alpha.audit.v1alpha1.PayloadOrganizationMetadataUpdated.description_update:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationMetadataUpdated.DescriptionUpdate
	62, // 62: buf.alpha.audit.v1alpha1.PayloadOrganizationMetadataUpdated.url_update:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationMetadataUpdated.UrlUpdate
	68, // 63: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberAdded.member_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	69, // 64: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberAdded.member_role_source:type_name -> buf.alpha.registry.v1alpha1.OrganizationRoleSource
	68, // 65: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged.old_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	68, // 66: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged.new_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	69, // 67: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged.old_member_role_source:type_name -> buf.alpha.registry.v1alpha1.OrganizationRoleSource
	69, // 68: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged.new_member_role_source:type_name -> buf.alpha.registry.v1alpha1.OrganizationRoleSource
	68, // 69: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRemoved.member_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	69, // 70: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRemoved.member_role_source:type_name -> buf.alpha.registry.v1alpha1.OrganizationRoleSource
	70, // 71: buf.alpha.audit.v1alpha1.PayloadRepositoryCreated.visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	70, // 72: buf.alpha.audit.v1alpha1.PayloadRepositoryDeleted.visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	70, // 73: buf.alpha.audit.v1alpha1.PayloadRepositoryDeprecated.visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	70, // 74: buf.alpha.audit.v1alpha1.PayloadRepositoryUndeprecated.visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	71, // 75: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorAdded.contributor_role:type_name -> buf.alpha.registry.v1alpha1.RepositoryRole
	71, // 76: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRoleChanged.old_role:type_name -> buf.alpha.registry.v1alpha1.RepositoryRole
	71, // 77: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRoleChanged.new_role:type_name -> buf.alpha.registry.v1alpha1.RepositoryRole
	71, // 78: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRemoved.contributor_role:type_name -> buf.alpha.registry.v1alpha1.RepositoryRole
	70, // 79: buf.alpha.audit.v1alpha1.PayloadRepositoryVisibilityChanged.old_visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	70, // 80: buf.alpha.audit.v1alpha1.PayloadRepositoryVisibilityChanged.new_visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	63, // 81: buf.alpha.audit.v1alpha1.PayloadRepositoryMetadataUpdated.description_update:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryMetadataUpdated.DescriptionUpdate
	64, // 82: buf.alpha.audit.v1alpha1.PayloadRepositoryMetadataUpdated.url_update:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryMetadataUpdated.UrlUpdate
	65, // 83: buf.alpha.audit.v1alpha1.PayloadUserMetadataUpdated.description_update:type_name -> buf.alpha.audit.v1alpha1.PayloadUserMetadataUpdated.DescriptionUpdate
	66, // 84: buf.alpha.audit.v1alpha1.PayloadUserMetadataUpdated.url_update:type_name -> buf.alpha.audit.v1alpha1.PayloadUserMetadataUpdated.UrlUpdate
	67, // 85: buf.alpha.audit.v1alpha1.PayloadTokenCreated.token_expiry_time:type_name -> google.protobuf.Timestamp
	67, // 86: buf.alpha.audit.v1alpha1.PayloadSCIMTokenCreated.token_expiry_time:type_name -> google.protobuf.Timestamp
	72, // 87: buf.alpha.audit.v1alpha1.PayloadServerBreakingChangePolicyEnabled.category:type_name -> buf.alpha.registry.v1alpha1.BreakingChangeCategory
...
func file_buf_alpha_audit_v1alpha1_event_proto_init() {
	...
	file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[3].OneofWrappers = []any{
		...
		(*Event_OrganizationMetadataUpdated)(nil),
		(*Event_OrganizationVerificationStatusChanged)(nil),
		...
		(*Event_RepositoryMetadataUpdated)(nil),
		...
		(*Event_UserMetadataUpdated)(nil),
		(*Event_UserVerificationStatusChanged)(nil),
	...
	file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[6].OneofWrappers = []any{}
	file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[24].OneofWrappers = []any{}
	file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[34].OneofWrappers = []any{}
	file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[48].OneofWrappers = []any{}
	type x struct{}
