...
type EventPayload struct {
	...
	//	*EventPayload_RepositoryReviewRequired
...
func (x *EventPayload) GetRepositoryReviewRequired() *RepositoryReviewRequiredEvent {
	if x, ok := x.GetPayload().(*EventPayload_RepositoryReviewRequired); ok {
		return x.RepositoryReviewRequired
	}
	return nil
}
...
type EventPayload_RepositoryReviewRequired struct {
	RepositoryReviewRequired *RepositoryReviewRequiredEvent `protobuf:"bytes,2,opt,name=repository_review_required,json=repositoryReviewRequired,proto3,oneof"`
}

func (*EventPayload_RepositoryPush) isEventPayload_Payload() {}

func (*EventPayload_RepositoryReviewRequired) isEventPayload_Payload() {}
...
// Payload for the event WEBHOOK_EVENT_REPOSITORY_REVIEW_REQUIRED.
type RepositoryReviewRequiredEvent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The timestamp of the commit that need to be reviewed was push.
	EventTime *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=event_time,json=eventTime,proto3" json:"event_time,omitempty"`
	// The repository commit that need to be reviewed.
	RepositoryCommit *v1alpha1.RepositoryCommit `protobuf:"bytes,2,opt,name=repository_commit,json=repositoryCommit,proto3" json:"repository_commit,omitempty"`
	// The repository that was pushed a commit that need to be reviewed.
	Repository *v1alpha1.Repository `protobuf:"bytes,3,opt,name=repository,proto3" json:"repository,omitempty"`
}

func (x *RepositoryReviewRequiredEvent) Reset() {
	*x = RepositoryReviewRequiredEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buf_alpha_webhook_v1alpha1_event_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RepositoryReviewRequiredEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepositoryReviewRequiredEvent) ProtoMessage() {}

func (x *RepositoryReviewRequiredEvent) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_webhook_v1alpha1_event_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepositoryReviewRequiredEvent.ProtoReflect.Descriptor instead.
func (*RepositoryReviewRequiredEvent) Descriptor() ([]byte, []int) {
	return file_buf_alpha_webhook_v1alpha1_event_proto_rawDescGZIP(), []int{4}
}

func (x *RepositoryReviewRequiredEvent) GetEventTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EventTime
	}
	return nil
...
func (x *RepositoryReviewRequiredEvent) GetRepositoryCommit() *v1alpha1.RepositoryCommit {
	if x != nil {
		return x.RepositoryCommit
	}
	return nil
...
func (x *RepositoryReviewRequiredEvent) GetRepository() *v1alpha1.Repository {
	if x != nil {
		return x.Repository
	}
	return nil
...
var file_buf_alpha_webhook_v1alpha1_event_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xf0, 0x01, 0x0a, 0x0c, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x5a, 0x0a, 0x0f, 0x72, 0x65,
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x5f, 0x70, 0x75, 0x73, 0x68, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x62, 0x75, 0x66, 0x2e, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e,
	0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
	...
	,
	...
	0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x47, 0x0a, 0x0a,
	...
	0x69, 0x74, 0x6f, 0x72, 0x79, 0x22, 0xff, 0x01, 0x0a, 0x1d, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72,
	0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x39, 0x0a, 0x0a, 0x65, 0x76, 0x65, 0x6e, 0x74,
	...
	0x6d, 0x65, 0x12, 0x5a, 0x0a, 0x11, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79,
	0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e,
	...
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x47,
	...
	,
	...
	,
...
var file_buf_alpha_webhook_v1alpha1_event_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_buf_alpha_webhook_v1alpha1_event_proto_goTypes = []interface{}{
	...
	(*RepositoryReviewRequiredEvent)(nil), // 4: buf.alpha.webhook.v1alpha1.RepositoryReviewRequiredEvent
	(v1alpha1.WebhookEvent)(0),            // 5: buf.alpha.registry.v1alpha1.WebhookEvent
	(*timestamppb.Timestamp)(nil),         // 6: google.protobuf.Timestamp
	(*v1alpha1.RepositoryCommit)(nil),     // 7: buf.alpha.registry.v1alpha1.RepositoryCommit
	(*v1alpha1.Repository)(nil),           // 8: buf.alpha.registry.v1alpha1.Repository
}
var file_buf_alpha_webhook_v1alpha1_event_proto_depIdxs = []int32{
	5,  // 0: buf.alpha.webhook.v1alpha1.EventRequest.event:type_name -> buf.alpha.registry.v1alpha1.WebhookEvent
	...
	4,  // 3: buf.alpha.webhook.v1alpha1.EventPayload.repository_review_required:type_name -> buf.alpha.webhook.v1alpha1.RepositoryReviewRequiredEvent
	6,  // 4: buf.alpha.webhook.v1alpha1.RepositoryPushEvent.event_time:type_name -> google.protobuf.Timestamp
	7,  // 5: buf.alpha.webhook.v1alpha1.RepositoryPushEvent.repository_commit:type_name -> buf.alpha.registry.v1alpha1.RepositoryCommit
	8,  // 6: buf.alpha.webhook.v1alpha1.RepositoryPushEvent.repository:type_name -> buf.alpha.registry.v1alpha1.Repository
	6,  // 7: buf.alpha.webhook.v1alpha1.RepositoryReviewRequiredEvent.event_time:type_name -> google.protobuf.Timestamp
	7,  // 8: buf.alpha.webhook.v1alpha1.RepositoryReviewRequiredEvent.repository_commit:type_name -> buf.alpha.registry.v1alpha1.RepositoryCommit
	8,  // 9: buf.alpha.webhook.v1alpha1.RepositoryReviewRequiredEvent.repository:type_name -> buf.alpha.registry.v1alpha1.Repository
	0,  // 10: buf.alpha.webhook.v1alpha1.EventService.Event:input_type -> buf.alpha.webhook.v1alpha1.EventRequest
	2,  // 11: buf.alpha.webhook.v1alpha1.EventService.Event:output_type -> buf.alpha.webhook.v1alpha1.EventResponse
...
func file_buf_alpha_webhook_v1alpha1_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_alpha_webhook_v1alpha1_event_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RepositoryReviewRequiredEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_buf_alpha_webhook_v1alpha1_event_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*EventPayload_RepositoryReviewRequired)(nil),
	}
	type x struct{}
