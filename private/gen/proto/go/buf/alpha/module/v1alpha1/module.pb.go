...
type Module struct {
	...
	BreakingConfig *v1.Config `protobuf:"bytes,5,opt,name=breaking_config,json=breakingConfig,proto3" json:"breaking_config,omitempty"`
	// lint_config is the lint configuration set for the module.
	LintConfig *v11.Config `protobuf:"bytes,6,opt,name=lint_config,json=lintConfig,proto3" json:"lint_config,omitempty"`
}
...
var file_buf_alpha_module_v1alpha1_module_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x62, 0x75, 0x66, 0x2e,
