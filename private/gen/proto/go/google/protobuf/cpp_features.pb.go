...
type CppFeatures struct {
	...
	EnumNameUsesStringView *bool                   `protobuf:"varint,3,opt,name=enum_name_uses_string_view,json=enumNameUsesStringView" json:"enum_name_uses_string_view,omitempty"`
...
func (x *CppFeatures) GetEnumNameUsesStringView() bool {
	if x != nil && x.EnumNameUsesStringView != nil {
		return *x.EnumNameUsesStringView
	}
	return false
}
...
func (x *CppFeatures) HasEnumNameUsesStringView() bool {
	...
	return x.EnumNameUsesStringView != nil
}
...
func (b0 CppFeatures_builder) Build() *CppFeatures {
	...
	x.EnumNameUsesStringView = b.EnumNameUsesStringView
	return m0
}
