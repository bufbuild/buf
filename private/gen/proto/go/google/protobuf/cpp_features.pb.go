...
type CppFeatures struct {
	...
	xxx_hidden_EnumNameUsesStringView bool                   `protobuf:"varint,3,opt,name=enum_name_uses_string_view,json=enumNameUsesStringView" json:"enum_name_uses_string_view,omitempty"`
