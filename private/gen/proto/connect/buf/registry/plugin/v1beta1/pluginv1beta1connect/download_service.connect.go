...
var (
	downloadServiceDownloadSpec = sync.OnceValue(func() connect.Spec {
		return connect.Spec{
			...
			Schema:           v1beta1.File_buf_registry_plugin_v1beta1_download_service_proto.Services().ByName("DownloadService").Methods().ByName("Download"),
...
// RegisterDownloadServiceHandler registers svc as the buf.registry.plugin.v1beta1.DownloadService
...
func (UnimplementedDownloadServiceHandler) Download(context.Context, *v1beta1.DownloadRequest) (*v1beta1.DownloadResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, "buf.registry.plugin.v1beta1.DownloadService.Download is not implemented")
}
...
func (c *downloadServiceClient) Download(ctx context.Context, req *v1beta1.DownloadRequest) (*v1beta1.DownloadResponse, error) {
	var res v1beta1.DownloadResponse
...
func (h downloadServiceHandler) download(ctx context.Context, _ connect.Spec, stream connect.ServerStream) error {
	var req v1beta1.DownloadRequest
