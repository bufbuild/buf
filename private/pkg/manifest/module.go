...
// FromProtoBlob returns A Blob from a proto module blob.
func FromProtoBlob(b *modulev1alpha1.Blob) (Blob, error) {
	if b == nil {
	...
	if err != nil {
		return nil, fmt.Errorf("new digester from hash type: %w", err)
	}
	return memBlob, nil
}
