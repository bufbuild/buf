...
func TestRubyPackageOptions(t *testing.T) {
	t.Parallel()
	testRubyPackageOptions(t, filepath.Join(testDataDir, "rubyoptions", "single"), `Acme::V1`)
	testRubyPackageOptions(t, filepath.Join(testDataDir, "rubyoptions", "double"), `Acme::Weather::V1`)
	testRubyPackageOptions(t, filepath.Join(testDataDir, "rubyoptions", "triple"), `Acme::Weather::Data::V1`)
	testRubyPackageOptions(t, filepath.Join(testDataDir, "rubyoptions", "underscore"), `Acme::Weather::FooBar::V1`)
}
...
func TestRubyPackageExcept(t *testing.T) {
	t.Parallel()
	dirPath := filepath.Join(testDataDir, "rubyoptions", "single")
