...
func (p *moduleDataStore) getModuleDataForModuleKey(
	...
	// opition when reading this file, because we have complete control over this bucket and can
	// expect all lock files in the module data store to have digests.
