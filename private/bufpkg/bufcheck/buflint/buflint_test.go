...
func TestRunProtovalidateRules(t *testing.T) {
	...
	testLintWithValidate(
		...
		bufanalysistesting.NewFileAnnotation(t, "number.proto", 32, 5, 32, 43, "PROTOVALIDATE"),
		bufanalysistesting.NewFileAnnotation(t, "number.proto", 35, 5, 35, 43, "PROTOVALIDATE"),
		bufanalysistesting.NewFileAnnotation(t, "number.proto", 39, 5, 39, 42, "PROTOVALIDATE"),
		...
		bufanalysistesting.NewFileAnnotation(t, "string.proto", 36, 5, 36, 40, "PROTOVALIDATE"),
