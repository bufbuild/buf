...
func TestValidateRulesTypeDontMatch(t *testing.T) {
	...
	testLint(t, "validate_rules_types_match",
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 13, 23, 13, 61, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 14, 25, 14, 63, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 15, 23, 15, 62, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 16, 23, 16, 62, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 17, 25, 17, 64, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 18, 25, 18, 66, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 19, 25, 19, 65, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 20, 25, 20, 60, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 21, 28, 21, 64, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 22, 28, 22, 65, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 23, 30, 23, 66, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 24, 30, 24, 66, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 25, 22, 25, 59, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 26, 26, 26, 63, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 27, 24, 27, 61, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 28, 36, 28, 71, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 29, 35, 29, 72, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 30, 36, 30, 72, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 31, 46, 31, 82, "VALIDATE_CONSTRAINTS_CHECK"),
		bufanalysistesting.NewFileAnnotation(t, "a.proto", 32, 48, 32, 87, "VALIDATE_CONSTRAINTS_CHECK"),
	)
}
