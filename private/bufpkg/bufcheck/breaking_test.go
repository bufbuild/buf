...
func TestRunBreakingFieldSameCppStringType(t *testing.T) {
	...
	testBreaking(
		...
		bufanalysistesting.NewFileAnnotation(t, "1.proto", 20, 21, 20, 55, "FIELD_SAME_CPP_STRING_TYPE"),
		...
		bufanalysistesting.NewFileAnnotation(t, "2.proto", 19, 22, 19, 32, "FIELD_SAME_CPP_STRING_TYPE"),
		...
		bufanalysistesting.NewFileAnnotation(t, "3.proto", 15, 24, 15, 58, "FIELD_SAME_CPP_STRING_TYPE"),
		...
		bufanalysistesting.NewFileAnnotation(t, "3.proto", 29, 38, 29, 72, "FIELD_SAME_CPP_STRING_TYPE"),
...
func TestRunBreakingFieldSameCType(t *testing.T) {
	...
	testBreaking(
		...
		bufanalysistesting.NewFileAnnotation(t, "2.proto", 7, 28, 7, 40, "FIELD_SAME_CPP_STRING_TYPE"),
		bufanalysistesting.NewFileAnnotation(t, "2.proto", 12, 28, 12, 40, "FIELD_SAME_CPP_STRING_TYPE"),
		bufanalysistesting.NewFileAnnotation(t, "2.proto", 17, 28, 17, 40, "FIELD_SAME_CPP_STRING_TYPE"),
		bufanalysistesting.NewFileAnnotation(t, "2.proto", 24, 32, 24, 44, "FIELD_SAME_CPP_STRING_TYPE"),
		bufanalysistesting.NewFileAnnotation(t, "2.proto", 45, 28, 45, 40, "FIELD_SAME_CPP_STRING_TYPE"),
