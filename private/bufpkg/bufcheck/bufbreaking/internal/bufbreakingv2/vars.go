...
var (
	// v2RuleBuilders are the rule builders.
	v2RuleBuilders = []*internal.RuleBuilder{
	...
	// v2DefaultCategories are the default categories.
	v2DefaultCategories = []string{
		"FILE",
	}
	// v2IDToCategories associates IDs to categories.
	v2IDToCategories = map[string][]string{
		"ENUM_NO_DELETE": {
			"FILE",
		},
