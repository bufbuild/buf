...
type Plugin interface {
	...
	// Languages returns the languages generated by the plugin.
	Languages() []string
}
...
func NewPlugin(
	...
	return newPlugin(version, dependencies, defaultOptions, registryConfig, imageDigest, sourceURL, description, languages)
}
