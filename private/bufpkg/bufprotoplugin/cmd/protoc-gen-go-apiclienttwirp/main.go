...
const (
	...
	httpclientPackage  = protogen.GoImportPath("github.com/bufbuild/buf/private/pkg/transport/http/httpclient")
	twirpclientPackage = protogen.GoImportPath("github.com/bufbuild/buf/private/pkg/transport/twirp/twirpclient")
