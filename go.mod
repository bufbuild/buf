...
require (
	buf.build/gen/go/bufbuild/buf/bufbuild/connect-go v1.3.2-20221206203657-13efcbfbc7dc.1
	buf.build/gen/go/bufbuild/buf/protocolbuffers/go v1.28.1-20221206203657-13efcbfbc7dc.4
