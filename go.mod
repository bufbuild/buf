...
require (
	buf.build/gen/go/bufbuild/bufplugin/protocolbuffers/go v1.36.6-20241023225133-42bdb4b67625.1
	...
	github.com/bufbuild/protovalidate-go v0.9.3-0.20250326175631-1f7bf08d9084
