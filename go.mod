...
require (
	buf.build/gen/go/bufbuild/bufplugin/protocolbuffers/go v1.34.2-20240828030811-3aee66b03a1e.2
	...
	pluginrpc.com/pluginrpc v0.1.1-0.20240830202149-02747f468d57
)

require (
	buf.build/gen/go/pluginrpc/pluginrpc/protocolbuffers/go v1.34.2-20240828201414-fe6866f2f15c.2 // indirect
