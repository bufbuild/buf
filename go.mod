...
require (
	buf.build/gen/go/bufbuild/bufplugin/protocolbuffers/go v1.34.2-20240807162203-18906b410a6f.2
	...
	github.com/bufbuild/bufplugin-go v0.0.0-20240807162742-145dad4a07b1
