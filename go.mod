...
require (
	buf.build/gen/go/bufbuild/bufplugin/protocolbuffers/go v1.35.1-20240928190436-5e8abcfd7a7e.1
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.35.1-20240717164558-a6c49f84cc0f.1
